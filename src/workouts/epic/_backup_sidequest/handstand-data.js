...
const handstands = [
  ...
  {
    id: 6,
    name: "Negative Handstand Push-Up | (Wall)",
  ...
  {
    id: 8,
    name: "Deficit Handstand Push-Up | (Parallettes)",
  ...
  {
    id: 18,
    name: "Fingertip Handstand Push-Up",
...
const handstandPantheonWorkouts = [
    ...
    },
  {
      ...
      technique: 5, mobility: 3, strength: 5,
      kcalPerRep: [3.5, 6],
      requires: ["pantheon-500121", "handstand-21"],
      requiresMode: "all",
      pantheonGroup: "Fingertip Handstand Push-Up",
