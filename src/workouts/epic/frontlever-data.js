...
const frontlevers = (() => {
  ...
  const pullStraddle = _flPullStraddle;
    ...
    entries.push(cloneExercise(tuck, {
      id: 1420,
      name: 'One-Arm Advanced Tuck FL | (Bar)',
    ...
    entries.push(cloneExercise(tuck, {
      id: 1421,
      name: 'One-Arm Advanced Tuck FL | (Parallettes)',
    ...
    entries.push(cloneExercise(tuck, {
      id: 1422,
      name: 'One-Arm Advanced Tuck FL | (Rings)',
    ...
    entries.push(cloneExercise(tuck, {
      id: 1502,
      name: 'Advanced Tuck FL | Hands Together (Bar)',
    ...
    entries.push(cloneExercise(full, {
      id: 1504,
      name: 'Front Lever | Hands Together (Bar)',
    ...
    entries.push(cloneExercise(tuck, {
      id: 1702,
      name: 'Advanced Tuck FL | Rings Together (Rings)',
    ...
    entries.push(cloneExercise(full, {
      id: 1704,
      name: 'Front Lever | Rings Together (Rings)',
    ...
    entries.push(cloneExercise(tuck, {
      id: 1902,
      name: 'Advanced Tuck FL | Side Grip (Parallettes)',
    ...
    entries.push(cloneExercise(full, {
      id: 1904,
      name: 'Front Lever | Side Grip (Parallettes)',
    ...
    entries.push(cloneExercise(tuck, {
      id: 2002,
      name: 'Advanced Tuck FL | Back Grip (Parallettes)',
    ...
    entries.push(cloneExercise(full, {
      id: 2004,
      name: 'Front Lever | Back Grip (Parallettes)',
    ...
    entries.push(cloneExercise(tuck, {
      id: 2102,
      name: 'Advanced Tuck FL | Supinated Grip (Bar)',
    ...
    entries.push(cloneExercise(full, {
      id: 2104,
      name: 'Front Lever | Supinated Grip (Bar)',
    ...
    entries.push(cloneExercise(tuck, {
      id: 2202,
      name: 'Advanced Tuck FL | Supinated Grip (Rings)',
    ...
    entries.push(cloneExercise(full, {
      id: 2204,
      name: 'Front Lever | Supinated Grip (Rings)',
    ...
    entries.push(cloneExercise(pullAdvanced, {
      id: 1602,
      name: 'Advanced Tuck FL | Pull-Up Hands Together (Bar)',
    ...
    entries.push(cloneExercise(pullAdvanced, {
      id: 1802,
      name: 'Advanced Tuck FL | Pull-Up Rings Together (Rings)',
    ...
    entries.push(cloneExercise(pullAdvanced, {
      id: 1907,
      name: 'Advanced Tuck FL | Pull-Up Side Grip (Parallettes)',
    ...
    entries.push(cloneExercise(pullAdvanced, {
      id: 2007,
      name: 'Advanced Tuck FL | Pull-Up Back Grip (Parallettes)',
    ...
    entries.push(cloneExercise(pullAdvanced, {
      id: 2107,
      name: 'Advanced Tuck FL | Pull-Up Supinated Grip (Bar)',
    ...
    entries.push(cloneExercise(pullAdvanced, {
      id: 2207,
      name: 'Advanced Tuck FL | Pull-Up Supinated Grip (Rings)',
  ...
  function isCompletedFrontLeverVariant(exercise) {
    ...
    // Matches any canonical FL or FL Pull-Up variant regardless of equipment suffix.
    // "Front Lever | (Bar)", "Front Lever | (Rings)", "Front Lever | Supinated Grip (Bar)" etc.
    return name.startsWith('Front Lever |')
