...
@media(max-width:767px){.viewer-panel{width:100%;max-width:100%;height:var(--viewer-h,62vh);height:var(--viewer-h,clamp(42svh,56svh,68svh))}}
...
/* ── INFO PANEL ── */
.info-panel{flex:1;overflow-y:auto;overflow-x:hidden;background:var(--bg2);display:flex;flex-direction:column;position:relative;min-width:0;min-height:min(360px,42svh)}
@media(max-width:767px){.info-panel{border-top:1px solid var(--border);min-height:min(280px,34svh)}}
