...
(function(){
  ...
  function spawnBoat(){
    ...
    var y = window.innerHeight*0.455 - h;
    ...
    boat.animate([
      { transform:'translate('+startX+'px,'+y+'px)'+(dir<0?' scaleX(-1)':''), opacity:0 },
      { opacity:0.9, offset:0.06 },
      { transform:'translate('+(startX+(endX-startX)*0.5)+'px,'+(y-3)+'px)'+(dir<0?' scaleX(-1)':''), opacity:0.9, offset:0.5 },
      { opacity:0.9, offset:0.94 },
      { transform:'translate('+endX+'px,'+y+'px)'+(dir<0?' scaleX(-1)':''), opacity:0 }
  ...
  function spawnWave(){
    ...
    wave.style.cssText = 'position:absolute; left:-2%; top:'+y+'px; width:104%; height:16px; '+
      'background:linear-gradient(180deg, rgba(255,255,255,0) 0%, rgba(255,255,255,0.85) 40%, rgba(230,248,252,0.5) 70%, rgba(255,255,255,0) 100%); '+
