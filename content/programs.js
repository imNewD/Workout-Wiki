...
const PROGRAMS = [
    ...
    },
    {
      ...
      weeks_data:[
          ...
          sessions:[
            {
              label:'Session',
              exercises:[
                {name:'Tuck BL — Parallettes', sets:'4', reps:'8–15s', note:'Hold the tucked position.'},
                {name:'Tuck BL Hold', sets:'4', reps:'8–15s', note:'Maintain the lean and shoulder tension.'},
          ...
          sessions:[
            {
              label:'Session',
              exercises:[
                {name:'Adv Tuck BL', sets:'4', reps:'8–15s', note:'Add lever length if the tuck is stable.'},
                {name:'One-Leg BL — Parallettes', sets:'4', reps:'5–10s/leg', note:'Increase load on one side.'},
        ...
        {
          title:'Phase 4 — Full BL', phase:'Build full lever strength and control',
          note:'Continue lean progression with full lever and negative work.',
          sessions:[
            {
              label:'Session',
              exercises:[
                {name:'BL — Parallettes', sets:'4', reps:'5–10s', note:'Attempt the full position with control.'},
                {name:'BL Negatives', sets:'4', reps:'3–5', note:'Slow descent from the top.'},
                {name:'BL Hold Attempts', sets:'4', reps:'max effort', note:'Try the hold fresh each set.'},
          ...
          sessions:[
            {
              ...
              exercises:[
                ...
                {name:'Tuck BL Raises', sets:'4', reps:'3–5', note:'Use the tuck position if available.'},
                {name:'BL Negative', sets:'4', reps:'3', note:'Slow descent from the top.'},
                {name:'One-Leg BL — Parallettes', sets:'3', reps:'5–10s/side', note:'Build one-side lever control.'},
          ...
          sessions:[
            {
              label:'Session',
              exercises:[
                {name:'Tuck BL — Rings', sets:'4', reps:'8–12s', note:'Use a safe ring tuck hold.'},
                {name:'One-Leg BL — Rings', sets:'4', reps:'5–10s/leg', note:'Add one-legged stability.'},
                {name:'BL — Rings', sets:'4', reps:'5–10s', note:'Attempt the full ring lever with support.'},
          ...
          sessions:[
            {
              ...
              exercises:[
                ...
                {name:'Tuck BL', sets:'4', reps:'8–12s', note:'Start the lever with a tight tuck.'},
                {name:'Negative BL', sets:'4', reps:'3', note:'Slow descent from the top.'},
...
(function(){
  ...
  function renderProgramsGrid() {
    ...
    grid.innerHTML     = customCard + active.map(p => isList ? renderProgramRow(p) : renderProgramCard(p)).join('');
    ...
    if(p.weeks_data && p.weeks_data.length) {
      ...
      const weekBlocks = p.weeks_data.map((wk, wi) => {
        const sessionsHtml = wk.sessions.map(sess => {
          const sessIsRest = /rest/i.test(sess.label || '') || !(Array.isArray(sess.exercises) && sess.exercises.length);
          if(sessIsRest) {
