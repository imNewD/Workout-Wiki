...
const frontleverPantheonWorkouts = [
    ...
    },
  {
      ...
      kcalPerRep: [0.44, 0.79],
      requires: ["frontlever-15", "frontlever-77"],
      requiresMode: "all",
      pantheonGroup: "Front Lever",
    ...
    },
  {
      ...
      technique: 5, mobility: 3, strength: 5,
      kcalPerRep: [5, 9],
      requires: ["frontlever-15", "frontlever-1004"],
      requiresMode: "all",
      pantheonGroup: "Front Lever",
      pantheonSubgroup: "Static",
    ...
    },
  {
      ...
      technique: 5, mobility: 3, strength: 5,
      kcalPerRep: [0.52, 0.93],
      requires: ["frontlever-15", "frontlever-77", "frontlever-1104"],
      requiresMode: "all",
      pantheonGroup: "Front Lever",
      pantheonSubgroup: "Mythic Pull",
    ...
    },
  {
      ...
      technique: 5, mobility: 3, strength: 5,
      kcalPerRep: [5, 9],
      requires: ["frontlever-15", "frontlever-1204"],
      requiresMode: "all",
      pantheonGroup: "Front Lever",
    ...
    },
  {
      ...
      technique: 5, mobility: 3, strength: 5,
      kcalPerRep: [0.52, 0.93],
      requires: ["frontlever-77", "frontlever-1304"],
      requiresMode: "all",
      pantheonGroup: "Front Lever",
