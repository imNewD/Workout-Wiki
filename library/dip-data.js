...
const dips = [
  ...
  {id:1, name:"Parallel Bar Dip", alt:"Chest dip · tricep dip",
   ...
   risk:2, joints:{wrist:2,shoulder:3,lowerBack:1,knee:0},
  ...
  {id:2, name:"Ring Dip", alt:"Gymnastic ring dip",
   ...
   risk:3, joints:{wrist:3,shoulder:4,lowerBack:1,knee:0},
  ...
  {id:47, name:"Weighted Dip (+25–50% BW)", alt:"Moderate loaded dip · belt dip medium",
   ...
   risk:3, joints:{wrist:2,shoulder:4,lowerBack:1,knee:0},
  ...
  {id:49, name:"Weighted Dip (+75%+ BW)", alt:"Extreme loaded dip · belt dip max",
   ...
   risk:4, joints:{wrist:2,shoulder:5,lowerBack:1,knee:0},
   technique:3, mobility:2, strength:5,
  ...
  {id:4, name:"Korean Dip", alt:"Behind-the-back dip · reverse dip",
   ...
   risk:4, joints:{wrist:3,shoulder:5,lowerBack:1,knee:0},
  ...
  {id:12, name:"Tuck Dip", alt:"Knees-tucked dip",
   ...
   risk:1, joints:{wrist:2,shoulder:2,lowerBack:1,knee:0},
   technique:1, mobility:1, strength:1,
  ...
  {id:43, name:"Ring Tuck Dip", alt:"Tuck ring dip",
   ...
   risk:2, joints:{wrist:3,shoulder:3,lowerBack:1,knee:0},
  ...
  {id:20, name:"Weighted Straight Bar Dip", alt:"Loaded bar dip",
   ...
   tags:["triceps","chest","shoulders","core"],
   diff:8, str:{suit:true,eff:5}, vol:{suit:false,eff:1}, end:{suit:false,eff:1},
   risk:5, joints:{wrist:3,shoulder:5,lowerBack:1,knee:0},
   technique:5, mobility:3, strength:5,
  ...
  {id:59, name:"One-Arm Ring Dip", alt:"Single-arm ring dip · unilateral ring dip",
   ...
   risk:5, joints:{wrist:5,shoulder:5,lowerBack:2,knee:0},
   technique:5, mobility:3, strength:5,
  ...
  {id:34, name:"Tuck Planche Dip", alt:"Tuck planche press dip",
   ...
   tags:["triceps","chest","shoulders","core"],
   diff:9, hof:true, str:{suit:true,eff:5}, vol:{suit:false,eff:1}, end:{suit:false,eff:1},
   risk:5, joints:{wrist:4,shoulder:4,lowerBack:3,knee:0},
   technique:5, mobility:3, strength:5,
  ...
  {id:51, name:"Advanced Tuck Planche Dip", alt:"Adv tuck planche press dip",
   ...
   tags:["triceps","chest","shoulders","core"],
   diff:10, hof:true, str:{suit:true,eff:5}, vol:{suit:false,eff:1}, end:{suit:false,eff:1},
   risk:5, joints:{wrist:5,shoulder:5,lowerBack:3,knee:0},
  ...
  {id:52, name:"German Dip", alt:"Deutsches Dip · European forearm dip",
   ...
   risk:4, joints:{wrist:1,shoulder:4,lowerBack:1,knee:0},
  ...
  {id:35, name:"Ring Dip — False Grip", alt:"False grip ring dip",
   ...
   tags:["triceps","chest","shoulders","core"],
   diff:7, str:{suit:true,eff:5}, vol:{suit:false,eff:2}, end:{suit:false,eff:1},
   risk:4, joints:{wrist:4,shoulder:4,lowerBack:1,knee:0},
   technique:5, mobility:2, strength:4,
  ...
  {id:60, name:"Ring Korean Dip", alt:"Korean dip on rings · reverse ring dip",
   ...
   diff:10, hof:true, str:{suit:true,eff:5}, vol:{suit:false,eff:1}, end:{suit:false,eff:1},
   risk:5, joints:{wrist:5,shoulder:5,lowerBack:1,knee:0},
  ...
  {id:39, name:"Maltese Dip", alt:"Maltese cross dip",
   ...
   diff:10, hof:true, str:{suit:true,eff:5}, vol:{suit:false,eff:1}, end:{suit:false,eff:1},
   risk:5, joints:{wrist:4,shoulder:5,lowerBack:3,knee:0},
   technique:5, mobility:3, strength:5,
  ...
  {id:40, name:"Iron Cross Dip", alt:"Cross dip · rings cross pressing",
   ...
   tags:["triceps","chest","shoulders","core","back"],
   diff:10, hof:true, str:{suit:true,eff:5}, vol:{suit:false,eff:1}, end:{suit:false,eff:1},
   risk:5, joints:{wrist:4,shoulder:5,lowerBack:2,knee:0},
   technique:5, mobility:3, strength:5,
  ...
  {id:71, name:"Pommel Horse Dip", alt:"Gymnastics pommel dip · pommel support dip",
   ...
   risk:3, joints:{wrist:3,shoulder:3,lowerBack:1,knee:0},
   technique:4, mobility:2, strength:3,
