...
const dips = [
  ...
  {id:1, name:"Parallel Bar Dip", alt:"Chest dip · tricep dip",
   ...
   risk:2, joints:{fingers:2,wrist:2,elbow:3,shoulder:3,neck:0,thoracic:0,lowerBack:1,si:0,hip:0,groin:0,knee:0,ankle:0,foot:0},
   technique:2, mobility:2, strength:2, kcalPerRep:[0.20, 0.37],
   ...
   equipment:"Parallel bars", position:"Vertical · Arms Supporting", youtube:"LINK_TODO"},

  {id:2, name:"Ring Dip", alt:"Gymnastic ring dip",
   muscles:[{n:"Triceps",p:true},{n:"Chest",p:true},{n:"Front Delts",p:false},{n:"Core",p:true}],
   tags:["triceps","chest","shoulders","core"],
   diff:5, str:{suit:true,eff:5}, vol:{suit:true,eff:4}, end:{suit:false,eff:2},
   risk:3, joints:{fingers:3,wrist:3,elbow:3,shoulder:4,neck:0,thoracic:0,lowerBack:1,si:0,hip:0,groin:0,knee:0,ankle:0,foot:0},
   technique:3, mobility:2, strength:3, kcalPerRep:[0.28, 0.50],
   ...
   equipment:"Gymnastic rings", position:"Vertical · Arms Supporting", youtube:"LINK_TODO"},

  {id:3, name:"Weighted Dip (+10–25% BW)", alt:"Light loaded dip · belt dip light",
   muscles:[{n:"Triceps",p:true},{n:"Chest",p:true},{n:"Front Delts",p:false},{n:"Core",p:false}],
   tags:["triceps","chest","shoulders"],
   diff:4, str:{suit:true,eff:4}, vol:{suit:true,eff:3}, end:{suit:false,eff:2},
   risk:2, joints:{fingers:2,wrist:2,elbow:3,shoulder:3,neck:0,thoracic:0,lowerBack:1,si:0,hip:0,groin:0,knee:0,ankle:0,foot:0},
   technique:2, mobility:2, strength:3, kcalPerRep:[0.25, 0.45],
   ...
   equipment:"Parallel bars + dip belt / weighted vest", position:"Vertical · Arms Supporting", youtube:"LINK_TODO"},

  {id:47, name:"Weighted Dip (+25–50% BW)", alt:"Moderate loaded dip · belt dip medium",
   muscles:[{n:"Triceps",p:true},{n:"Chest",p:true},{n:"Front Delts",p:false},{n:"Core",p:false}],
   tags:["triceps","chest","shoulders"],
   diff:5, str:{suit:true,eff:5}, vol:{suit:true,eff:3}, end:{suit:false,eff:1},
   risk:3, joints:{fingers:3,wrist:2,elbow:4,shoulder:4,neck:0,thoracic:0,lowerBack:1,si:0,hip:0,groin:0,knee:0,ankle:0,foot:0},
   technique:2, mobility:2, strength:4, kcalPerRep:[0.28, 0.50],
   ...
   equipment:"Parallel bars + dip belt", position:"Vertical · Arms Supporting", youtube:"LINK_TODO"},

  {id:48, name:"Weighted Dip (+50–75% BW)", alt:"Heavy loaded dip · belt dip heavy",
   muscles:[{n:"Triceps",p:true},{n:"Chest",p:true},{n:"Front Delts",p:false},{n:"Core",p:false}],
   tags:["triceps","chest","shoulders"],
   diff:6, str:{suit:true,eff:5}, vol:{suit:false,eff:2}, end:{suit:false,eff:1},
   risk:3, joints:{fingers:3,wrist:2,elbow:4,shoulder:4,neck:0,thoracic:0,lowerBack:1,si:0,hip:0,groin:0,knee:0,ankle:0,foot:0},
   technique:3, mobility:2, strength:5, kcalPerRep:[0.32, 0.58],
  ...
  {id:49, name:"Weighted Dip (+75%+ BW)", alt:"Extreme loaded dip · belt dip max",
   muscles:[{n:"Triceps",p:true},{n:"Chest",p:true},{n:"Front Delts",p:false},{n:"Core",p:false}],
   tags:["triceps","chest","shoulders"],
   diff:8, hof:true, str:{suit:true,eff:5}, vol:{suit:false,eff:1}, end:{suit:false,eff:1},
   risk:4, joints:{fingers:4,wrist:2,elbow:5,shoulder:5,neck:0,thoracic:0,lowerBack:1,si:0,hip:0,groin:0,knee:0,ankle:0,foot:0},
   technique:3, mobility:2, strength:5, kcalPerRep:[0.35, 0.63],
  ...
  {id:4, name:"Korean Dip", alt:"Behind-the-back dip · reverse dip",
   muscles:[{n:"Triceps",p:true},{n:"Rear Delts",p:true},{n:"Chest",p:false},{n:"Core",p:false}],
   tags:["triceps","shoulders","back"],
   diff:6, str:{suit:true,eff:4}, vol:{suit:false,eff:2}, end:{suit:false,eff:2},
   risk:4, joints:{fingers:3,wrist:3,elbow:3,shoulder:5,neck:0,thoracic:0,lowerBack:1,si:0,hip:0,groin:0,knee:0,ankle:0,foot:0},
   technique:4, mobility:3, strength:3, kcalPerRep:[0.24, 0.44],
   ...
   equipment:"Parallel bars / low bar / dip station", position:"Vertical · Arms Supporting", youtube:"LINK_TODO"},

  {id:5, name:"Tiger Bend", alt:"Forearm-to-handstand press · tiger bend push-up",
   muscles:[{n:"Triceps",p:true},{n:"Shoulders",p:true},{n:"Chest",p:false},{n:"Core",p:true}],
   tags:["triceps","shoulders","core"],
   diff:8, str:{suit:true,eff:5}, vol:{suit:false,eff:1}, end:{suit:false,eff:1},
   risk:4, joints:{fingers:3,wrist:3,elbow:4,shoulder:4,neck:0,thoracic:1,lowerBack:2,si:0,hip:0,groin:0,knee:0,ankle:0,foot:0},
   technique:5, mobility:3, strength:5, kcalPerRep:[0.40, 0.72],
   ...
   equipment:"Floor / parallettes", position:"Inverted", youtube:"LINK_TODO"},

  {id:6, name:"Band-Assisted Dip", alt:"Banded dip · assisted dip",
   muscles:[{n:"Triceps",p:true},{n:"Chest",p:true},{n:"Front Delts",p:false},{n:"Core",p:false}],
   tags:["triceps","chest","shoulders"],
   diff:1, str:{suit:false,eff:2}, vol:{suit:true,eff:3}, end:{suit:true,eff:4},
   risk:1, joints:{fingers:1,wrist:1,elbow:2,shoulder:2,neck:0,thoracic:0,lowerBack:1,si:0,hip:0,groin:0,knee:0,ankle:0,foot:0},
   technique:1, mobility:1, strength:1, kcalPerRep:[0.12, 0.21],
   ...
   equipment:"Parallel bars + resistance band", position:"Vertical · Arms Supporting", youtube:"LINK_TODO"},

  {id:7, name:"Bench Dip", alt:"Tricep dip · chair dip",
   muscles:[{n:"Triceps",p:true},{n:"Front Delts",p:false},{n:"Chest",p:false}],
   tags:["triceps","shoulders","chest"],
   diff:2, str:{suit:true,eff:3}, vol:{suit:true,eff:3}, end:{suit:true,eff:4},
   risk:3, joints:{fingers:1,wrist:2,elbow:2,shoulder:4,neck:0,thoracic:0,lowerBack:1,si:0,hip:0,groin:0,knee:0,ankle:0,foot:0},
   technique:1, mobility:2, strength:1, kcalPerRep:[0.13, 0.24],
   ...
   equipment:"Bench / chair", position:"Vertical · Arms Supporting", youtube:"LINK_TODO"},

  {id:8, name:"L-Sit Dip", alt:"L-sit parallel bar dip",
   ...
   risk:3, joints:{fingers:2,wrist:2,elbow:3,shoulder:3,neck:0,thoracic:0,lowerBack:2,si:0,hip:3,groin:0,knee:0,ankle:0,foot:0},
  ...
  {id:9, name:"Negative Dip", alt:"Eccentric dip · slow lower",
   muscles:[{n:"Triceps",p:true},{n:"Chest",p:true},{n:"Front Delts",p:false},{n:"Core",p:false}],
   tags:["triceps","chest","shoulders"],
   diff:2, str:{suit:true,eff:3}, vol:{suit:true,eff:3}, end:{suit:false,eff:2},
   risk:2, joints:{fingers:2,wrist:2,elbow:3,shoulder:3,neck:0,thoracic:0,lowerBack:1,si:0,hip:0,groin:0,knee:0,ankle:0,foot:0},
   technique:2, mobility:2, strength:1, kcalPerRep:[0.23, 0.42],
   ...
   equipment:"Parallel bars + box or step to jump from", position:"Vertical · Arms Supporting", youtube:"LINK_TODO"},

  {id:10, name:"Straight Bar Dip", alt:"Bar dip · muscle-up lockout dip",
   muscles:[{n:"Triceps",p:true},{n:"Chest",p:true},{n:"Front Delts",p:true},{n:"Core",p:true}],
   tags:["triceps","chest","shoulders","core"],
   diff:6, str:{suit:true,eff:5}, vol:{suit:false,eff:2}, end:{suit:false,eff:1},
   risk:4, joints:{fingers:3,wrist:3,elbow:3,shoulder:4,neck:0,thoracic:0,lowerBack:1,si:0,hip:0,groin:0,knee:0,ankle:0,foot:0},
   technique:4, mobility:3, strength:4, kcalPerRep:[0.26, 0.47],
   ...
   equipment:"Straight pull-up bar / dip bar", position:"Vertical · Arms Supporting", youtube:"LINK_TODO"},

  /* ── PROGRESSIONS & REGRESSIONS ─────────────────────────── */

  {id:11, name:"Box Dip", alt:"Floor dip · ground-level dip",
   ...
   risk:1, joints:{fingers:1,wrist:1,elbow:1,shoulder:2,neck:0,thoracic:0,lowerBack:1,si:0,hip:0,groin:0,knee:0,ankle:0,foot:0},
   technique:1, mobility:1, strength:1, kcalPerRep:[0.09, 0.16],
   ...
   equipment:"Low box / step", position:"Vertical · Arms Supporting", youtube:"LINK_TODO"},

  {id:12, name:"Tuck Dip", alt:"Knees-tucked dip",
   muscles:[{n:"Triceps",p:true},{n:"Chest",p:true},{n:"Front Delts",p:false},{n:"Core",p:false}],
   tags:["triceps","chest","shoulders"],
   diff:2, str:{suit:false,eff:2}, vol:{suit:true,eff:3}, end:{suit:true,eff:4},
   risk:1, joints:{fingers:1,wrist:2,elbow:2,shoulder:2,neck:0,thoracic:0,lowerBack:1,si:0,hip:0,groin:0,knee:0,ankle:0,foot:0},
   technique:1, mobility:1, strength:1, kcalPerRep:[0.15, 0.26],
  ...
  {id:13, name:"Assisted Machine Dip", alt:"Counterweighted dip · machine-assisted dip",
   muscles:[{n:"Triceps",p:true},{n:"Chest",p:true},{n:"Front Delts",p:false},{n:"Core",p:false}],
   tags:["triceps","chest","shoulders"],
   diff:1, str:{suit:false,eff:1}, vol:{suit:true,eff:3}, end:{suit:true,eff:4},
   risk:1, joints:{fingers:1,wrist:1,elbow:2,shoulder:2,neck:0,thoracic:0,lowerBack:1,si:0,hip:0,groin:0,knee:0,ankle:0,foot:0},
   technique:1, mobility:1, strength:1, kcalPerRep:[0.10, 0.18],
   ...
   equipment:"Assisted dip machine", position:"Vertical · Arms Supporting", youtube:"LINK_TODO"},

  {id:14, name:"Feet-Supported Dip", alt:"Foot-assisted dip",
   muscles:[{n:"Triceps",p:true},{n:"Chest",p:true},{n:"Front Delts",p:false},{n:"Core",p:false}],
   tags:["triceps","chest","shoulders"],
   diff:2, str:{suit:false,eff:2}, vol:{suit:true,eff:3}, end:{suit:true,eff:4},
   risk:1, joints:{fingers:1,wrist:1,elbow:2,shoulder:2,neck:0,thoracic:0,lowerBack:1,si:0,hip:0,groin:0,knee:0,ankle:0,foot:0},
   ...
   equipment:"Parallel bars + bench / box", position:"Vertical · Arms Supporting", youtube:"LINK_TODO"},

  {id:43, name:"Ring Tuck Dip", alt:"Tuck ring dip",
   muscles:[{n:"Triceps",p:true},{n:"Chest",p:true},{n:"Front Delts",p:false},{n:"Core",p:true}],
   tags:["triceps","chest","shoulders","core"],
   diff:4, str:{suit:false,eff:2}, vol:{suit:true,eff:3}, end:{suit:true,eff:4},
   risk:2, joints:{fingers:3,wrist:3,elbow:3,shoulder:3,neck:0,thoracic:0,lowerBack:1,si:0,hip:0,groin:0,knee:0,ankle:0,foot:0},
   technique:3, mobility:2, strength:2, kcalPerRep:[0.17, 0.32],
  ...
  {id:46, name:"Korean Dip Negative", alt:"Eccentric Korean dip · Korean dip slow lower",
   muscles:[{n:"Triceps",p:true},{n:"Rear Delts",p:true},{n:"Chest",p:false},{n:"Core",p:false}],
   tags:["triceps","shoulders","back"],
   diff:5, str:{suit:true,eff:3}, vol:{suit:false,eff:1}, end:{suit:false,eff:1},
   risk:4, joints:{fingers:3,wrist:3,elbow:3,shoulder:5,neck:0,thoracic:0,lowerBack:1,si:0,hip:0,groin:0,knee:0,ankle:0,foot:0},
   technique:4, mobility:3, strength:2, kcalPerRep:[0.19, 0.34],
   ...
   equipment:"Parallel bars / low bar + step or box to reach starting position", position:"Vertical · Arms Supporting", youtube:"LINK_TODO"},

  /* ── GRIP & SURFACE VARIATIONS ──────────────────────────── */

  {id:15, name:"Wide-Grip Dip", alt:"Wide parallel bar dip",
   muscles:[{n:"Chest",p:true},{n:"Triceps",p:false},{n:"Front Delts",p:false},{n:"Core",p:false}],
   tags:["chest","triceps","shoulders"],
   diff:4, str:{suit:true,eff:4}, vol:{suit:true,eff:4}, end:{suit:false,eff:2},
   risk:3, joints:{fingers:2,wrist:2,elbow:3,shoulder:4,neck:0,thoracic:0,lowerBack:1,si:0,hip:0,groin:0,knee:0,ankle:0,foot:0},
   technique:2, mobility:2, strength:3, kcalPerRep:[0.20, 0.37],
   ...
   equipment:"Wide parallel bars / adjustable dip station", position:"Vertical · Arms Supporting", youtube:"LINK_TODO"},

  {id:16, name:"Narrow-Grip Dip", alt:"Close-grip dip · tricep-isolation dip",
   muscles:[{n:"Triceps",p:true},{n:"Chest",p:false},{n:"Front Delts",p:false},{n:"Core",p:false}],
   tags:["triceps","chest","shoulders"],
   diff:4, str:{suit:true,eff:5}, vol:{suit:true,eff:4}, end:{suit:false,eff:2},
   risk:2, joints:{fingers:2,wrist:2,elbow:4,shoulder:3,neck:0,thoracic:0,lowerBack:1,si:0,hip:0,groin:0,knee:0,ankle:0,foot:0},
   technique:2, mobility:2, strength:3, kcalPerRep:[0.20, 0.37],
   ...
   equipment:"Narrow parallel bars / parallettes", position:"Vertical · Arms Supporting", youtube:"LINK_TODO"},

  {id:17, name:"Parallette Dip", alt:"P-bar dip · low bar dip",
   muscles:[{n:"Triceps",p:true},{n:"Chest",p:true},{n:"Front Delts",p:false},{n:"Core",p:false}],
   tags:["triceps","chest","shoulders","core"],
   diff:3, str:{suit:true,eff:4}, vol:{suit:true,eff:4}, end:{suit:true,eff:3},
   risk:2, joints:{fingers:2,wrist:1,elbow:3,shoulder:3,neck:0,thoracic:0,lowerBack:1,si:0,hip:0,groin:0,knee:0,ankle:0,foot:0},
   technique:2, mobility:2, strength:2, kcalPerRep:[0.20, 0.37],
   ...
   equipment:"Parallettes", position:"Vertical · Arms Supporting", youtube:"LINK_TODO"},

  {id:50, name:"Chest Dip", alt:"Forward lean dip · pec dip",
   muscles:[{n:"Chest",p:true},{n:"Triceps",p:false},{n:"Front Delts",p:true},{n:"Core",p:false}],
   tags:["chest","triceps","shoulders"],
   diff:3, str:{suit:true,eff:4}, vol:{suit:true,eff:4}, end:{suit:true,eff:3},
   risk:2, joints:{fingers:2,wrist:2,elbow:3,shoulder:3,neck:0,thoracic:0,lowerBack:1,si:0,hip:0,groin:0,knee:0,ankle:0,foot:0},
   technique:2, mobility:2, strength:2, kcalPerRep:[0.20, 0.37],
  ...
  {id:18, name:"Ring Dip — Turned Out", alt:"RTO dip · externally rotated ring dip",
   muscles:[{n:"Triceps",p:true},{n:"Chest",p:true},{n:"Front Delts",p:true},{n:"Core",p:true}],
   tags:["triceps","chest","shoulders","core"],
   diff:7, str:{suit:true,eff:5}, vol:{suit:false,eff:2}, end:{suit:false,eff:1},
   risk:3, joints:{fingers:4,wrist:3,elbow:4,shoulder:4,neck:0,thoracic:0,lowerBack:1,si:0,hip:0,groin:0,knee:0,ankle:0,foot:0},
  ...
  {id:19, name:"Weighted Ring Dip", alt:"Loaded ring dip · belt ring dip",
   muscles:[{n:"Triceps",p:true},{n:"Chest",p:true},{n:"Front Delts",p:false},{n:"Core",p:true}],
   tags:["triceps","chest","shoulders","core"],
   diff:7, str:{suit:true,eff:5}, vol:{suit:false,eff:2}, end:{suit:false,eff:1},
   risk:4, joints:{fingers:4,wrist:3,elbow:4,shoulder:4,neck:0,thoracic:0,lowerBack:1,si:0,hip:0,groin:0,knee:0,ankle:0,foot:0},
   technique:4, mobility:2, strength:5, kcalPerRep:[0.33, 0.60],
   ...
   equipment:"Gymnastic rings + dip belt / weighted vest", position:"Vertical · Arms Supporting", youtube:"LINK_TODO"},

  {id:20, name:"Weighted Straight Bar Dip", alt:"Loaded bar dip",
   muscles:[{n:"Triceps",p:true},{n:"Chest",p:true},{n:"Front Delts",p:true},{n:"Core",p:true}],
   tags:["triceps","chest","shoulders","core"],
   diff:8, str:{suit:true,eff:5}, vol:{suit:false,eff:1}, end:{suit:false,eff:1},
   risk:5, joints:{fingers:4,wrist:3,elbow:5,shoulder:5,neck:0,thoracic:0,lowerBack:1,si:0,hip:0,groin:0,knee:0,ankle:0,foot:0},
   technique:5, mobility:3, strength:5, kcalPerRep:[0.35, 0.63],
   ...
   equipment:"Straight bar + dip belt / weighted vest", position:"Vertical · Arms Supporting", youtube:"LINK_TODO"},

  {id:44, name:"Weighted L-Sit Dip", alt:"Loaded L-sit dip · belt L-sit dip",
   muscles:[{n:"Triceps",p:true},{n:"Chest",p:true},{n:"Hip Flexors",p:true},{n:"Core",p:true}],
   tags:["triceps","chest","shoulders","core"],
   diff:9, hof:true, str:{suit:true,eff:5}, vol:{suit:false,eff:1}, end:{suit:false,eff:1},
   risk:4, joints:{fingers:3,wrist:2,elbow:4,shoulder:4,neck:0,thoracic:0,lowerBack:3,si:1,hip:4,groin:0,knee:0,ankle:0,foot:0},
   technique:5, mobility:3, strength:5, kcalPerRep:[0.39, 0.69],
  ...
  {id:55, name:"Weighted Bench Dip", alt:"Loaded bench dip · plate bench dip",
   muscles:[{n:"Triceps",p:true},{n:"Front Delts",p:false},{n:"Chest",p:false}],
   tags:["triceps","shoulders","chest"],
   diff:3, str:{suit:true,eff:3}, vol:{suit:true,eff:3}, end:{suit:false,eff:2},
   risk:4, joints:{fingers:1,wrist:2,elbow:3,shoulder:4,neck:0,thoracic:0,lowerBack:1,si:0,hip:0,groin:0,knee:0,ankle:0,foot:0},
   technique:2, mobility:2, strength:2, kcalPerRep:[0.16, 0.29],
   ...
   equipment:"Bench / chair + weight plate / dumbbell", position:"Vertical · Arms Supporting", youtube:"LINK_TODO"},

  {id:56, name:"Weighted Parallette Dip", alt:"Loaded parallette dip · belt p-bar dip",
   muscles:[{n:"Triceps",p:true},{n:"Chest",p:true},{n:"Front Delts",p:false},{n:"Core",p:false}],
   tags:["triceps","chest","shoulders"],
   diff:5, str:{suit:true,eff:5}, vol:{suit:true,eff:3}, end:{suit:false,eff:1},
   risk:2, joints:{fingers:2,wrist:1,elbow:4,shoulder:3,neck:0,thoracic:0,lowerBack:1,si:0,hip:0,groin:0,knee:0,ankle:0,foot:0},
   technique:2, mobility:2, strength:4, kcalPerRep:[0.25, 0.45],
   ...
   equipment:"Parallettes + dip belt / weighted vest", position:"Vertical · Arms Supporting", youtube:"LINK_TODO"},

  {id:61, name:"Band-Resisted Dip", alt:"Loaded band dip · banded resistance dip",
   muscles:[{n:"Triceps",p:true},{n:"Chest",p:true},{n:"Front Delts",p:false},{n:"Core",p:false}],
   tags:["triceps","chest","shoulders"],
   diff:5, str:{suit:true,eff:5}, vol:{suit:true,eff:3}, end:{suit:false,eff:1},
   risk:2, joints:{fingers:2,wrist:2,elbow:4,shoulder:3,neck:0,thoracic:0,lowerBack:1,si:0,hip:0,groin:0,knee:0,ankle:0,foot:0},
   technique:3, mobility:2, strength:4, kcalPerRep:[0.23, 0.42],
   ...
   equipment:"Parallel bars + resistance band + overhead anchor point", position:"Vertical · Arms Supporting", youtube:"LINK_TODO"},

  /* ── UNILATERAL VARIATIONS ──────────────────────────────── */

  {id:21, name:"Archer Dip", alt:"One-arm assisted dip · unilateral dip",
   muscles:[{n:"Triceps",p:true},{n:"Chest",p:true},{n:"Front Delts",p:false},{n:"Core",p:true}],
   tags:["triceps","chest","shoulders","core"],
   diff:7, str:{suit:true,eff:5}, vol:{suit:false,eff:2}, end:{suit:false,eff:1},
   risk:3, joints:{fingers:3,wrist:2,elbow:4,shoulder:3,neck:0,thoracic:0,lowerBack:1,si:0,hip:0,groin:0,knee:0,ankle:0,foot:0},
   technique:4, mobility:2, strength:4, kcalPerRep:[0.30, 0.54],
  ...
  {id:22, name:"One-Arm Dip", alt:"Single-arm dip · unilateral parallel bar dip",
   muscles:[{n:"Triceps",p:true},{n:"Chest",p:true},{n:"Front Delts",p:true},{n:"Core",p:true}],
   tags:["triceps","chest","shoulders","core"],
   diff:9, hof:true, str:{suit:true,eff:5}, vol:{suit:false,eff:1}, end:{suit:false,eff:1},
   risk:4, joints:{fingers:4,wrist:3,elbow:5,shoulder:4,neck:0,thoracic:0,lowerBack:2,si:0,hip:0,groin:0,knee:0,ankle:0,foot:0},
   technique:5, mobility:2, strength:5, kcalPerRep:[0.35, 0.63],
   ...
   equipment:"Parallel bars / single bar / sturdy edge", position:"Vertical · Arms Supporting", youtube:"LINK_TODO"},

  {id:23, name:"One-Arm Negative Dip", alt:"Eccentric one-arm dip · unilateral slow lower",
   muscles:[{n:"Triceps",p:true},{n:"Chest",p:true},{n:"Front Delts",p:true},{n:"Core",p:true}],
   tags:["triceps","chest","shoulders","core"],
   diff:7, str:{suit:true,eff:5}, vol:{suit:false,eff:1}, end:{suit:false,eff:1},
   risk:4, joints:{fingers:4,wrist:3,elbow:5,shoulder:4,neck:0,thoracic:0,lowerBack:2,si:0,hip:0,groin:0,knee:0,ankle:0,foot:0},
   technique:5, mobility:2, strength:4, kcalPerRep:[0.26, 0.47],
  ...
  {id:59, name:"One-Arm Ring Dip", alt:"Single-arm ring dip · unilateral ring dip",
   muscles:[{n:"Triceps",p:true},{n:"Chest",p:true},{n:"Front Delts",p:true},{n:"Core",p:true}],
   tags:["triceps","chest","shoulders","core"],
   diff:10, hof:true, str:{suit:true,eff:5}, vol:{suit:false,eff:1}, end:{suit:false,eff:1},
   risk:5, joints:{fingers:5,wrist:5,elbow:5,shoulder:5,neck:0,thoracic:0,lowerBack:2,si:0,hip:0,groin:0,knee:0,ankle:0,foot:0},
   technique:5, mobility:3, strength:5, kcalPerRep:[0.42, 0.76],
  ...
  {id:24, name:"Pause Dip", alt:"Dead-stop dip · 90° pause dip",
   muscles:[{n:"Triceps",p:true},{n:"Chest",p:true},{n:"Front Delts",p:false},{n:"Core",p:false}],
   tags:["triceps","chest","shoulders"],
   diff:4, str:{suit:true,eff:5}, vol:{suit:true,eff:4}, end:{suit:false,eff:2},
   risk:2, joints:{fingers:2,wrist:2,elbow:3,shoulder:3,neck:0,thoracic:0,lowerBack:1,si:0,hip:0,groin:0,knee:0,ankle:0,foot:0},
  ...
  {id:25, name:"Tempo Dip", alt:"Slow dip · 3-1-3 dip",
   muscles:[{n:"Triceps",p:true},{n:"Chest",p:true},{n:"Front Delts",p:false},{n:"Core",p:false}],
   tags:["triceps","chest","shoulders"],
   diff:4, str:{suit:true,eff:5}, vol:{suit:true,eff:4}, end:{suit:false,eff:2},
   risk:2, joints:{fingers:2,wrist:2,elbow:3,shoulder:3,neck:0,thoracic:0,lowerBack:1,si:0,hip:0,groin:0,knee:0,ankle:0,foot:0},
   technique:2, mobility:2, strength:3, kcalPerRep:[0.30, 0.54],
  ...
  {id:26, name:"Isometric Support Hold", alt:"Dip lockout hold · top hold",
   muscles:[{n:"Triceps",p:true},{n:"Chest",p:false},{n:"Front Delts",p:false},{n:"Core",p:true}],
   tags:["triceps","chest","shoulders","core"],
   diff:1, str:{suit:false,eff:2}, vol:{suit:false,eff:1}, end:{suit:true,eff:4},
   risk:1, joints:{fingers:1,wrist:2,elbow:1,shoulder:2,neck:0,thoracic:0,lowerBack:1,si:0,hip:0,groin:0,knee:0,ankle:0,foot:0},
  ...
  {id:27, name:"Bottom Isometric Hold", alt:"90° hold · sticking point hold",
   muscles:[{n:"Triceps",p:true},{n:"Chest",p:true},{n:"Front Delts",p:true},{n:"Core",p:false}],
   tags:["triceps","chest","shoulders"],
   diff:4, str:{suit:true,eff:4}, vol:{suit:false,eff:2}, end:{suit:true,eff:3},
   risk:2, joints:{fingers:2,wrist:2,elbow:3,shoulder:3,neck:0,thoracic:0,lowerBack:1,si:0,hip:0,groin:0,knee:0,ankle:0,foot:0},
   technique:2, mobility:2, strength:2, kcalPerRep:[0.16, 0.29],
  ...
  {id:57, name:"Ring Support Hold", alt:"Ring lockout hold · ring top hold",
   muscles:[{n:"Triceps",p:true},{n:"Chest",p:false},{n:"Front Delts",p:false},{n:"Core",p:true}],
   tags:["triceps","chest","shoulders","core"],
   diff:3, str:{suit:false,eff:2}, vol:{suit:false,eff:1}, end:{suit:true,eff:4},
   risk:2, joints:{fingers:2,wrist:3,elbow:2,shoulder:3,neck:0,thoracic:0,lowerBack:1,si:0,hip:0,groin:0,knee:0,ankle:0,foot:0},
   technique:3, mobility:2, strength:2, kcalPerRep:[0.08, 0.14],
  ...
  {id:58, name:"Korean Dip Support Hold", alt:"Korean dip top hold · reverse dip hold",
   muscles:[{n:"Triceps",p:true},{n:"Rear Delts",p:true},{n:"Chest",p:false},{n:"Core",p:false}],
   tags:["triceps","shoulders","back"],
   diff:4, str:{suit:false,eff:2}, vol:{suit:false,eff:1}, end:{suit:true,eff:3},
   risk:4, joints:{fingers:2,wrist:3,elbow:2,shoulder:5,neck:0,thoracic:0,lowerBack:1,si:0,hip:0,groin:0,knee:0,ankle:0,foot:0},
   technique:3, mobility:3, strength:2, kcalPerRep:[0.10, 0.18],
  ...
  {id:28, name:"Explosive Dip", alt:"Plyometric dip · jump dip",
   muscles:[{n:"Triceps",p:true},{n:"Chest",p:true},{n:"Front Delts",p:false},{n:"Core",p:false}],
   tags:["triceps","chest","shoulders"],
  ...
  {id:29, name:"Clap Dip", alt:"Plyometric clap dip",
   muscles:[{n:"Triceps",p:true},{n:"Chest",p:true},{n:"Front Delts",p:false},{n:"Core",p:false}],
   tags:["triceps","chest","shoulders"],
   diff:7, str:{suit:true,eff:5}, vol:{suit:false,eff:1}, end:{suit:false,eff:1},
   risk:3, joints:{fingers:3,wrist:2,elbow:4,shoulder:3,neck:0,thoracic:0,lowerBack:1,si:0,hip:0,groin:0,knee:0,ankle:0,foot:0},
  ...
  {id:30, name:"Russian Dip", alt:"Forearm dip · rolling dip",
   muscles:[{n:"Triceps",p:true},{n:"Chest",p:false},{n:"Shoulders",p:true},{n:"Core",p:true}],
   tags:["triceps","shoulders","core"],
   diff:6, str:{suit:true,eff:4}, vol:{suit:false,eff:2}, end:{suit:false,eff:2},
   risk:3, joints:{fingers:2,wrist:1,elbow:3,shoulder:3,neck:0,thoracic:0,lowerBack:1,si:0,hip:0,groin:0,knee:0,ankle:0,foot:0},
   technique:4, mobility:3, strength:3, kcalPerRep:[0.26, 0.47],
  ...
  {id:31, name:"Dip Shrug", alt:"Scapular dip · support shrug",
   muscles:[{n:"Lats",p:true},{n:"Core",p:false},{n:"Chest",p:false}],
   tags:["triceps","shoulders","back"],
   diff:1, str:{suit:false,eff:1}, vol:{suit:false,eff:1}, end:{suit:true,eff:3},
   risk:1, joints:{fingers:1,wrist:1,elbow:1,shoulder:1,neck:0,thoracic:0,lowerBack:1,si:0,hip:0,groin:0,knee:0,ankle:0,foot:0},
   technique:2, mobility:1, strength:1, kcalPerRep:[0.07, 0.13],
  ...
  {id:32, name:"Straddle L-Sit Dip", alt:"Straddle dip · wide-leg L dip",
   muscles:[{n:"Triceps",p:true},{n:"Chest",p:true},{n:"Hip Flexors",p:true},{n:"Core",p:true}],
   tags:["triceps","chest","shoulders","core"],
   diff:8, str:{suit:true,eff:5}, vol:{suit:false,eff:1}, end:{suit:false,eff:1},
   risk:3, joints:{fingers:2,wrist:2,elbow:3,shoulder:3,neck:0,thoracic:0,lowerBack:2,si:0,hip:3,groin:2,knee:0,ankle:0,foot:0},
   technique:5, mobility:3, strength:5, kcalPerRep:[0.32, 0.58],
  ...
  {id:33, name:"Kipping Dip", alt:"Kip dip · CrossFit dip",
   muscles:[{n:"Triceps",p:true},{n:"Chest",p:true},{n:"Shoulders",p:true},{n:"Core",p:true}],
   tags:["triceps","chest","shoulders","core"],
   diff:4, str:{suit:false,eff:2}, vol:{suit:false,eff:2}, end:{suit:true,eff:5},
   risk:3, joints:{fingers:2,wrist:2,elbow:3,shoulder:4,neck:0,thoracic:0,lowerBack:2,si:0,hip:2,groin:0,knee:0,ankle:0,foot:0},
   technique:3, mobility:2, strength:2, kcalPerRep:[0.22, 0.40],
  ...
  {id:34, name:"Tuck Planche Dip", alt:"Tuck planche press dip",
   muscles:[{n:"Triceps",p:true},{n:"Chest",p:true},{n:"Shoulders",p:true},{n:"Core",p:true}],
   tags:["triceps","chest","shoulders","core"],
   diff:9, hof:true, str:{suit:true,eff:5}, vol:{suit:false,eff:1}, end:{suit:false,eff:1},
   risk:5, joints:{fingers:4,wrist:4,elbow:4,shoulder:4,neck:0,thoracic:1,lowerBack:3,si:0,hip:3,groin:0,knee:0,ankle:0,foot:0},
   technique:5, mobility:3, strength:5, kcalPerRep:[0.38, 0.68],
  ...
  {id:51, name:"Advanced Tuck Planche Dip", alt:"Adv tuck planche press dip",
   muscles:[{n:"Triceps",p:true},{n:"Chest",p:true},{n:"Shoulders",p:true},{n:"Core",p:true}],
   tags:["triceps","chest","shoulders","core"],
   diff:10, hof:true, str:{suit:true,eff:5}, vol:{suit:false,eff:1}, end:{suit:false,eff:1},
   risk:5, joints:{fingers:5,wrist:5,elbow:5,shoulder:5,neck:0,thoracic:1,lowerBack:3,si:1,hip:4,groin:0,knee:0,ankle:0,foot:0},
  ...
  {id:41, name:"Straddle Planche Dip", alt:"Straddle planche press dip",
   muscles:[{n:"Triceps",p:true},{n:"Chest",p:true},{n:"Shoulders",p:true},{n:"Core",p:true}],
   tags:["triceps","chest","shoulders","core"],
   diff:10, hof:true, str:{suit:true,eff:5}, vol:{suit:false,eff:1}, end:{suit:false,eff:1},
   risk:5, joints:{fingers:5,wrist:5,elbow:5,shoulder:5,neck:0,thoracic:1,lowerBack:3,si:1,hip:4,groin:3,knee:0,ankle:0,foot:0},
   technique:5, mobility:4, strength:5, kcalPerRep:[0.41, 0.74],
  ...
  {id:45, name:"Straight Bar L-Sit Dip", alt:"Bar L-sit dip",
   muscles:[{n:"Triceps",p:true},{n:"Chest",p:true},{n:"Front Delts",p:true},{n:"Hip Flexors",p:true},{n:"Core",p:true}],
   tags:["triceps","chest","shoulders","core"],
   diff:8, str:{suit:true,eff:5}, vol:{suit:false,eff:1}, end:{suit:false,eff:1},
   risk:4, joints:{fingers:3,wrist:3,elbow:3,shoulder:4,neck:0,thoracic:0,lowerBack:2,si:0,hip:3,groin:0,knee:0,ankle:0,foot:0},
   technique:5, mobility:3, strength:5, kcalPerRep:[0.34, 0.61],
  ...
  {id:52, name:"German Dip", alt:"Deutsches Dip · European forearm dip",
   muscles:[{n:"Triceps",p:true},{n:"Shoulders",p:true},{n:"Core",p:true},{n:"Chest",p:false}],
   tags:["triceps","shoulders","core"],
   diff:7, str:{suit:true,eff:4}, vol:{suit:false,eff:2}, end:{suit:false,eff:1},
   risk:4, joints:{fingers:2,wrist:1,elbow:3,shoulder:4,neck:0,thoracic:0,lowerBack:1,si:0,hip:0,groin:0,knee:0,ankle:0,foot:0},
   technique:5, mobility:4, strength:3, kcalPerRep:[0.28, 0.50],
  ...
  {id:35, name:"Ring Dip — False Grip", alt:"False grip ring dip",
   muscles:[{n:"Triceps",p:true},{n:"Chest",p:true},{n:"Front Delts",p:false},{n:"Core",p:true}],
   tags:["triceps","chest","shoulders","core"],
   diff:7, str:{suit:true,eff:5}, vol:{suit:false,eff:2}, end:{suit:false,eff:1},
   risk:4, joints:{fingers:4,wrist:4,elbow:4,shoulder:4,neck:0,thoracic:0,lowerBack:1,si:0,hip:0,groin:0,knee:0,ankle:0,foot:0},
   technique:5, mobility:2, strength:4, kcalPerRep:[0.30, 0.54],
  ...
  {id:36, name:"Impossible Dip", alt:"Between-chairs dip · deficit dip",
   muscles:[{n:"Triceps",p:true},{n:"Chest",p:true},{n:"Front Delts",p:true},{n:"Core",p:true}],
   tags:["triceps","chest","shoulders","core"],
   diff:7, str:{suit:true,eff:5}, vol:{suit:true,eff:3}, end:{suit:false,eff:2},
   risk:4, joints:{fingers:2,wrist:2,elbow:3,shoulder:4,neck:0,thoracic:0,lowerBack:1,si:0,hip:0,groin:0,knee:0,ankle:0,foot:0},
   technique:4, mobility:3, strength:4, kcalPerRep:[0.29, 0.52],
   ...
   equipment:"2 chairs / boxes / parallettes", position:"Vertical · Arms Supporting", youtube:"LINK_TODO"},

  {id:37, name:"Ring Dip — L-Sit", alt:"Ring L-sit dip",
   muscles:[{n:"Triceps",p:true},{n:"Chest",p:true},{n:"Hip Flexors",p:true},{n:"Core",p:true}],
   tags:["triceps","chest","shoulders","core"],
   diff:8, str:{suit:true,eff:5}, vol:{suit:false,eff:1}, end:{suit:false,eff:1},
   risk:4, joints:{fingers:3,wrist:3,elbow:3,shoulder:4,neck:0,thoracic:0,lowerBack:2,si:0,hip:3,groin:0,knee:0,ankle:0,foot:0},
  ...
  {id:38, name:"Weighted Korean Dip", alt:"Loaded Korean dip · belt Korean dip",
   muscles:[{n:"Triceps",p:true},{n:"Rear Delts",p:true},{n:"Chest",p:false},{n:"Core",p:false}],
   tags:["triceps","shoulders","back"],
   diff:8, str:{suit:true,eff:5}, vol:{suit:false,eff:1}, end:{suit:false,eff:1},
   risk:5, joints:{fingers:3,wrist:3,elbow:3,shoulder:5,neck:0,thoracic:0,lowerBack:1,si:0,hip:0,groin:0,knee:0,ankle:0,foot:0},
   ...
   equipment:"Parallel bars / low bar + dip belt", position:"Vertical · Arms Supporting", youtube:"LINK_TODO"},

  {id:53, name:"TRX Dip", alt:"Suspension trainer dip · strap dip",
   muscles:[{n:"Triceps",p:true},{n:"Chest",p:true},{n:"Front Delts",p:false},{n:"Core",p:true}],
   tags:["triceps","chest","shoulders","core"],
   diff:5, str:{suit:true,eff:4}, vol:{suit:true,eff:3}, end:{suit:false,eff:2},
   risk:3, joints:{fingers:3,wrist:3,elbow:3,shoulder:4,neck:0,thoracic:0,lowerBack:1,si:0,hip:0,groin:0,knee:0,ankle:0,foot:0},
   ...
   equipment:"TRX / suspension trainer", position:"Vertical · Arms Supporting", youtube:"LINK_TODO"},

  {id:54, name:"Pike Dip", alt:"Angled dip · decline position dip",
   muscles:[{n:"Front Delts",p:true},{n:"Chest",p:true},{n:"Triceps",p:false},{n:"Core",p:true}],
   tags:["shoulders","chest","triceps","core"],
   diff:4, str:{suit:true,eff:4}, vol:{suit:true,eff:3}, end:{suit:false,eff:2},
   risk:2, joints:{fingers:3,wrist:2,elbow:3,shoulder:3,neck:0,thoracic:0,lowerBack:1,si:0,hip:2,groin:0,knee:0,ankle:0,foot:0},
   technique:3, mobility:2, strength:3, kcalPerRep:[0.24, 0.43],
   ...
   equipment:"Parallettes / parallel bars + elevated surface for feet", position:"Vertical · Arms Supporting", youtube:"LINK_TODO"},

  /* ── EXTREME / HALL OF FAME ─────────────────────────────── */

  {id:42, name:"Full Planche Dip", alt:"Planche dip · planche press",
   muscles:[{n:"Triceps",p:true},{n:"Chest",p:true},{n:"Shoulders",p:true},{n:"Core",p:true}],
   tags:["triceps","chest","shoulders","core"],
   diff:10, hof:true, str:{suit:true,eff:5}, vol:{suit:false,eff:1}, end:{suit:false,eff:1},
   risk:5, joints:{fingers:5,wrist:5,elbow:5,shoulder:5,neck:0,thoracic:1,lowerBack:3,si:1,hip:4,groin:0,knee:0,ankle:0,foot:0},
   technique:5, mobility:4, strength:5, kcalPerRep:[0.44, 0.79],
  ...
  {id:60, name:"Ring Korean Dip", alt:"Korean dip on rings · reverse ring dip",
   muscles:[{n:"Triceps",p:true},{n:"Rear Delts",p:true},{n:"Chest",p:false},{n:"Core",p:true}],
   tags:["triceps","shoulders","back","core"],
   diff:10, hof:true, str:{suit:true,eff:5}, vol:{suit:false,eff:1}, end:{suit:false,eff:1},
   risk:5, joints:{fingers:5,wrist:5,elbow:4,shoulder:5,neck:0,thoracic:0,lowerBack:1,si:0,hip:0,groin:0,knee:0,ankle:0,foot:0},
   technique:5, mobility:5, strength:5, kcalPerRep:[0.40, 0.72],
  ...
  {id:39, name:"Maltese Dip", alt:"Maltese cross dip",
   muscles:[{n:"Triceps",p:true},{n:"Chest",p:true},{n:"Shoulders",p:true},{n:"Core",p:true},{n:"Back",p:true}],
   tags:["triceps","chest","shoulders","core","back"],
   diff:10, hof:true, str:{suit:true,eff:5}, vol:{suit:false,eff:1}, end:{suit:false,eff:1},
   risk:5, joints:{fingers:4,wrist:4,elbow:5,shoulder:5,neck:0,thoracic:1,lowerBack:3,si:0,hip:0,groin:0,knee:0,ankle:0,foot:0},
   technique:5, mobility:3, strength:5, kcalPerRep:[0.43, 0.77],
  ...
  {id:40, name:"Iron Cross Dip", alt:"Cross dip · rings cross pressing",
   muscles:[{n:"Triceps",p:true},{n:"Chest",p:true},{n:"Shoulders",p:true},{n:"Core",p:true},{n:"Back",p:true}],
   tags:["triceps","chest","shoulders","core","back"],
   diff:10, hof:true, str:{suit:true,eff:5}, vol:{suit:false,eff:1}, end:{suit:false,eff:1},
   risk:5, joints:{fingers:4,wrist:4,elbow:5,shoulder:5,neck:0,thoracic:0,lowerBack:2,si:0,hip:0,groin:0,knee:0,ankle:0,foot:0},
   technique:5, mobility:3, strength:5, kcalPerRep:[0.42, 0.76],
  ...
  {id:62, name:"Typewriter Dip", alt:"Lateral shift dip · side-to-side dip",
   muscles:[{n:"Triceps",p:true},{n:"Chest",p:true},{n:"Front Delts",p:false},{n:"Core",p:true}],
   tags:["triceps","chest","shoulders","core"],
   diff:6, str:{suit:true,eff:4}, vol:{suit:false,eff:2}, end:{suit:false,eff:1},
   risk:3, joints:{fingers:2,wrist:2,elbow:3,shoulder:3,neck:0,thoracic:0,lowerBack:1,si:0,hip:0,groin:0,knee:0,ankle:0,foot:0},
  ...
  {id:63, name:"Gironda Dip", alt:"V-bar dip · Vince Gironda dip",
   muscles:[{n:"Chest",p:true},{n:"Front Delts",p:true},{n:"Triceps",p:false},{n:"Core",p:false}],
   tags:["chest","shoulders","triceps"],
   diff:4, str:{suit:true,eff:4}, vol:{suit:true,eff:4}, end:{suit:false,eff:2},
   risk:3, joints:{fingers:2,wrist:2,elbow:3,shoulder:4,neck:0,thoracic:0,lowerBack:1,si:0,hip:0,groin:0,knee:0,ankle:0,foot:0},
   technique:3, mobility:2, strength:3, kcalPerRep:[0.21, 0.38],
   ...
   equipment:"V-bar dip station", position:"Vertical · Arms Supporting", youtube:"LINK_TODO"},

  {id:67, name:"Reverse Grip Dip", alt:"Supinated dip · underhand dip",
   muscles:[{n:"Front Delts",p:true},{n:"Chest",p:true},{n:"Triceps",p:false},{n:"Core",p:false}],
   tags:["shoulders","chest","triceps"],
   diff:5, str:{suit:true,eff:3}, vol:{suit:true,eff:3}, end:{suit:false,eff:2},
   risk:4, joints:{fingers:3,wrist:4,elbow:3,shoulder:4,neck:0,thoracic:0,lowerBack:1,si:0,hip:0,groin:0,knee:0,ankle:0,foot:0},
   technique:3, mobility:3, strength:3, kcalPerRep:[0.20, 0.36],
   ...
   equipment:"Parallel bars / low bar with grip clearance", position:"Vertical · Arms Supporting", youtube:"LINK_TODO"},

  /* ── UNILATERAL VARIATIONS (new) ────────────────────────── */

  {id:66, name:"One-Arm Bench Dip", alt:"Single-arm bench dip · unilateral bench dip",
   muscles:[{n:"Triceps",p:true},{n:"Front Delts",p:false},{n:"Chest",p:false}],
   tags:["triceps","shoulders","chest"],
   diff:4, str:{suit:true,eff:3}, vol:{suit:true,eff:3}, end:{suit:false,eff:2},
   risk:4, joints:{fingers:2,wrist:2,elbow:3,shoulder:4,neck:0,thoracic:0,lowerBack:1,si:0,hip:0,groin:0,knee:0,ankle:0,foot:0},
   technique:3, mobility:2, strength:2, kcalPerRep:[0.18, 0.32],
  ...
  {id:64, name:"Ring Archer Dip", alt:"One-arm assisted ring dip · ring unilateral dip",
   muscles:[{n:"Triceps",p:true},{n:"Chest",p:true},{n:"Front Delts",p:false},{n:"Core",p:true}],
   tags:["triceps","chest","shoulders","core"],
   diff:8, str:{suit:true,eff:5}, vol:{suit:false,eff:1}, end:{suit:false,eff:1},
   risk:4, joints:{fingers:4,wrist:4,elbow:5,shoulder:4,neck:0,thoracic:0,lowerBack:1,si:0,hip:0,groin:0,knee:0,ankle:0,foot:0},
   technique:5, mobility:2, strength:5, kcalPerRep:[0.37, 0.67],
  ...
  {id:65, name:"Explosive Ring Dip", alt:"Plyometric ring dip · jump ring dip",
   muscles:[{n:"Triceps",p:true},{n:"Chest",p:true},{n:"Front Delts",p:false},{n:"Core",p:true}],
   tags:["triceps","chest","shoulders","core"],
   diff:8, str:{suit:true,eff:5}, vol:{suit:false,eff:1}, end:{suit:false,eff:1},
   risk:4, joints:{fingers:4,wrist:4,elbow:5,shoulder:4,neck:0,thoracic:0,lowerBack:1,si:0,hip:0,groin:0,knee:0,ankle:0,foot:0},
   technique:5, mobility:2, strength:5, kcalPerRep:[0.33, 0.59],
  ...
  {id:70, name:"Explosive Straight Bar Dip", alt:"Plyometric bar dip · jump straight bar dip",
   muscles:[{n:"Triceps",p:true},{n:"Chest",p:true},{n:"Front Delts",p:true},{n:"Core",p:true}],
   tags:["triceps","chest","shoulders","core"],
   diff:8, str:{suit:true,eff:5}, vol:{suit:false,eff:1}, end:{suit:false,eff:1},
   risk:4, joints:{fingers:4,wrist:3,elbow:5,shoulder:4,neck:0,thoracic:0,lowerBack:1,si:0,hip:0,groin:0,knee:0,ankle:0,foot:0},
   technique:5, mobility:3, strength:5, kcalPerRep:[0.32, 0.57],
  ...
  /* ── LOADED VARIATIONS (new) ─────────────────────────────── */

  {id:68, name:"Weighted Typewriter Dip", alt:"Loaded typewriter dip · belt typewriter dip",
   muscles:[{n:"Triceps",p:true},{n:"Chest",p:true},{n:"Front Delts",p:false},{n:"Core",p:true}],
   tags:["triceps","chest","shoulders","core"],
   diff:7, str:{suit:true,eff:5}, vol:{suit:false,eff:1}, end:{suit:false,eff:1},
   risk:3, joints:{fingers:3,wrist:2,elbow:4,shoulder:3,neck:0,thoracic:0,lowerBack:1,si:0,hip:0,groin:0,knee:0,ankle:0,foot:0},
   technique:4, mobility:2, strength:4, kcalPerRep:[0.31, 0.56],
  ...
  {id:69, name:"Weighted Gironda Dip", alt:"Loaded V-bar dip · belt Gironda dip",
   muscles:[{n:"Chest",p:true},{n:"Front Delts",p:true},{n:"Triceps",p:false},{n:"Core",p:false}],
   tags:["chest","shoulders","triceps"],
   diff:5, str:{suit:true,eff:5}, vol:{suit:true,eff:3}, end:{suit:false,eff:1},
   risk:4, joints:{fingers:2,wrist:2,elbow:4,shoulder:5,neck:0,thoracic:0,lowerBack:1,si:0,hip:0,groin:0,knee:0,ankle:0,foot:0},
   technique:3, mobility:2, strength:4, kcalPerRep:[0.25, 0.45],
   ...
   equipment:"V-bar dip station + dip belt / weighted vest", position:"Vertical · Arms Supporting", youtube:"LINK_TODO"},

  /* ── SPECIALITY SURFACE VARIATIONS (new) ────────────────── */

  {id:71, name:"Pommel Horse Dip", alt:"Gymnastics pommel dip · pommel support dip",
   muscles:[{n:"Triceps",p:true},{n:"Chest",p:true},{n:"Front Delts",p:false},{n:"Core",p:true}],
   tags:["triceps","chest","shoulders","core"],
   diff:5, str:{suit:true,eff:4}, vol:{suit:false,eff:2}, end:{suit:false,eff:2},
   risk:3, joints:{fingers:3,wrist:3,elbow:3,shoulder:3,neck:0,thoracic:0,lowerBack:1,si:0,hip:0,groin:0,knee:0,ankle:0,foot:0},
   technique:4, mobility:2, strength:3, kcalPerRep:[0.22, 0.40],
   ...
   equipment:"Pommel horse", position:"Vertical · Arms Supporting", youtube:"LINK_TODO"},
];
