...
const handstands = [
  ...
  {id:1, name:"Wall Walk", alt:"Wall walk-up · inverted ramp",
   muscles:[{n:"Shoulders",p:true},{n:"Core",p:true},{n:"Triceps",p:false},{n:"Wrists",p:false}],
   tags:["shoulders","core","wrists"],
   diff:2, str:{suit:false,eff:1}, vol:{suit:true,eff:2}, end:{suit:true,eff:3},
   risk:1, joints:{fingers:1,wrist:2,elbow:1,shoulder:2,neck:1,thoracic:1,lowerBack:1,si:0,hip:1,groin:0,knee:0,ankle:0,foot:0},
   technique:1, mobility:1, strength:1, kcalPerRep:[0.8, 1.5],
   ...
   equipment:"Wall", position:"Inverted", youtube:"LINK_TODO"},

  {id:2, name:"Wall Handstand", alt:"Stomach-to-wall hold · chest-to-wall hold",
   muscles:[{n:"Shoulders",p:true},{n:"Core",p:true},{n:"Triceps",p:false},{n:"Wrists",p:false}],
   tags:["shoulders","core","wrists"],
   diff:3, str:{suit:true,eff:2}, vol:{suit:false,eff:1}, end:{suit:true,eff:3},
   risk:2, joints:{fingers:2,wrist:3,elbow:1,shoulder:3,neck:1,thoracic:1,lowerBack:1,si:0,hip:1,groin:0,knee:0,ankle:0,foot:0},
   technique:3, mobility:2, strength:2, kcalPerRep:[2.0, 3.5],
  ...
  {id:3, name:"Kick to Wall Handstand", alt:"Handstand kick-up · wall kick-up",
   muscles:[{n:"Shoulders",p:true},{n:"Core",p:true},{n:"Hip Flexors",p:false},{n:"Wrists",p:false}],
   tags:["shoulders","core","wrists"],
   diff:3, str:{suit:false,eff:1}, vol:{suit:false,eff:1}, end:{suit:true,eff:2},
   risk:2, joints:{fingers:1,wrist:3,elbow:1,shoulder:2,neck:1,thoracic:0,lowerBack:1,si:0,hip:2,groin:0,knee:0,ankle:0,foot:0},
   technique:3, mobility:2, strength:1, kcalPerRep:[1.0, 1.8],
  ...
  {id:4, name:"Tuck Handstand", alt:"Tuck balance · bent-knee freestanding handstand",
   muscles:[{n:"Shoulders",p:true},{n:"Core",p:true},{n:"Forearms",p:false},{n:"Wrists",p:false}],
   tags:["shoulders","core","wrists"],
   diff:4, str:{suit:false,eff:1}, vol:{suit:false,eff:1}, end:{suit:true,eff:3},
   risk:2, joints:{fingers:2,wrist:3,elbow:1,shoulder:3,neck:1,thoracic:1,lowerBack:1,si:0,hip:1,groin:0,knee:0,ankle:0,foot:0},
   technique:4, mobility:1, strength:2, kcalPerRep:[2.0, 3.5],
   ...
   equipment:"None", position:"Inverted", youtube:"LINK_TODO"},

  {id:5, name:"Freestanding Handstand", alt:"Free handstand · straight handstand hold",
   muscles:[{n:"Shoulders",p:true},{n:"Core",p:true},{n:"Forearms",p:false},{n:"Wrists",p:false}],
   tags:["shoulders","core","wrists"],
   diff:6, str:{suit:true,eff:2}, vol:{suit:false,eff:1}, end:{suit:true,eff:4},
   risk:3, joints:{fingers:3,wrist:4,elbow:1,shoulder:3,neck:1,thoracic:1,lowerBack:2,si:0,hip:1,groin:0,knee:0,ankle:0,foot:0},
   technique:5, mobility:2, strength:3, kcalPerRep:[3.0, 5.0],
  ...
  {id:6, name:"Negative Handstand Push-Up", alt:"HSPU eccentric · handstand push-up negative",
   muscles:[{n:"Shoulders",p:true},{n:"Triceps",p:true},{n:"Upper Traps",p:false},{n:"Core",p:false}],
   tags:["shoulders","triceps","core"],
   diff:4, str:{suit:true,eff:3}, vol:{suit:true,eff:2}, end:{suit:false,eff:1},
   risk:3, joints:{fingers:2,wrist:3,elbow:3,shoulder:4,neck:2,thoracic:1,lowerBack:1,si:0,hip:0,groin:0,knee:0,ankle:0,foot:0},
   technique:3, mobility:2, strength:3, kcalPerRep:[0.5, 0.9],
  ...
  {id:7, name:"Wall Handstand Push-Up", alt:"Wall HSPU · strict handstand push-up",
   muscles:[{n:"Shoulders",p:true},{n:"Triceps",p:true},{n:"Upper Traps",p:false},{n:"Core",p:false}],
   tags:["shoulders","triceps","core"],
   diff:5, str:{suit:true,eff:4}, vol:{suit:true,eff:3}, end:{suit:false,eff:1},
   risk:3, joints:{fingers:2,wrist:3,elbow:3,shoulder:4,neck:2,thoracic:1,lowerBack:1,si:0,hip:0,groin:0,knee:0,ankle:0,foot:0},
   technique:3, mobility:2, strength:3, kcalPerRep:[0.7, 1.3],
  ...
  {id:8, name:"Deficit Handstand Push-Up", alt:"Parallette HSPU · deep handstand push-up",
   muscles:[{n:"Shoulders",p:true},{n:"Triceps",p:true},{n:"Upper Traps",p:false},{n:"Core",p:false}],
   tags:["shoulders","triceps"],
   diff:7, str:{suit:true,eff:5}, vol:{suit:true,eff:4}, end:{suit:false,eff:1},
   risk:4, joints:{fingers:2,wrist:3,elbow:4,shoulder:5,neck:2,thoracic:1,lowerBack:1,si:0,hip:0,groin:0,knee:0,ankle:0,foot:0},
   technique:4, mobility:3, strength:4, kcalPerRep:[0.9, 1.6],
   ...
   equipment:"Parallettes or push-up handles + wall", position:"Inverted", youtube:"LINK_TODO"},

  {id:9, name:"Freestanding Handstand Push-Up", alt:"Free HSPU · freestanding strict HSPU",
   muscles:[{n:"Shoulders",p:true},{n:"Triceps",p:true},{n:"Core",p:true},{n:"Upper Traps",p:false}],
   tags:["shoulders","triceps","core"],
   diff:8, str:{suit:true,eff:5}, vol:{suit:false,eff:1}, end:{suit:false,eff:1},
   risk:4, joints:{fingers:3,wrist:4,elbow:3,shoulder:5,neck:2,thoracic:1,lowerBack:2,si:0,hip:1,groin:0,knee:0,ankle:0,foot:0},
   technique:5, mobility:3, strength:5, kcalPerRep:[1.0, 1.8],
   ...
   equipment:"None (parallettes strongly recommended)", position:"Inverted", youtube:"LINK_TODO"},

  /* ── ADVANCED SKILLS ─────────────────────────────────────── */

  {id:10, name:"Handstand Walk", alt:"Walking on hands · hand walking",
   muscles:[{n:"Shoulders",p:true},{n:"Core",p:true},{n:"Forearms",p:false},{n:"Wrists",p:false}],
   tags:["shoulders","core","wrists"],
   diff:5, str:{suit:false,eff:1}, vol:{suit:true,eff:3}, end:{suit:true,eff:4},
   risk:3, joints:{fingers:3,wrist:4,elbow:1,shoulder:3,neck:1,thoracic:1,lowerBack:1,si:0,hip:1,groin:0,knee:0,ankle:0,foot:0},
   technique:4, mobility:2, strength:2, kcalPerRep:[1.5, 2.5],
  ...
  {id:11, name:"Press Handstand", alt:"Straddle press · pike press to handstand",
   muscles:[{n:"Shoulders",p:true},{n:"Core",p:true},{n:"Hip Flexors",p:true},{n:"Hamstrings",p:false}],
   tags:["shoulders","core"],
   diff:8, str:{suit:true,eff:3}, vol:{suit:false,eff:1}, end:{suit:false,eff:1},
   risk:3, joints:{fingers:3,wrist:3,elbow:1,shoulder:4,neck:1,thoracic:2,lowerBack:2,si:1,hip:3,groin:2,knee:0,ankle:0,foot:0},
   technique:5, mobility:3, strength:4, kcalPerRep:[2.0, 3.5],
   ...
   equipment:"None (parallettes recommended)", position:"Inverted", youtube:"LINK_TODO"},

  {id:12, name:"Handstand Pirouette", alt:"Handstand turn · 360° handstand rotation",
   muscles:[{n:"Shoulders",p:true},{n:"Core",p:true},{n:"Forearms",p:false},{n:"Wrists",p:false}],
   tags:["shoulders","core","wrists"],
   diff:7, str:{suit:false,eff:1}, vol:{suit:false,eff:1}, end:{suit:true,eff:3},
   risk:3, joints:{fingers:3,wrist:4,elbow:1,shoulder:3,neck:1,thoracic:2,lowerBack:1,si:0,hip:1,groin:0,knee:0,ankle:0,foot:0},
   technique:5, mobility:2, strength:3, kcalPerRep:[2.5, 4.0],
  ...
  {id:13, name:"One-Arm Handstand", alt:"One-arm balance · unilateral handstand",
   muscles:[{n:"Shoulders",p:true},{n:"Core",p:true},{n:"Forearms",p:true},{n:"Wrists",p:false}],
   tags:["shoulders","core","wrists"],
   diff:10, str:{suit:true,eff:3}, vol:{suit:false,eff:1}, end:{suit:false,eff:1},
   risk:4, joints:{fingers:4,wrist:5,elbow:2,shoulder:4,neck:1,thoracic:2,lowerBack:3,si:1,hip:2,groin:0,knee:0,ankle:0,foot:0},
  ...
  {id:14, name:"Wall Fingertip Handstand", alt:"Fingertip wall hold · fingertip inverted hold",
   muscles:[{n:"Shoulders",p:true},{n:"Finger Flexors",p:true},{n:"Forearms",p:true},{n:"Core",p:false}],
   tags:["shoulders","core","wrists","fingers"],
   diff:4, str:{suit:true,eff:3}, vol:{suit:false,eff:1}, end:{suit:true,eff:3},
   risk:3, joints:{fingers:4,wrist:2,elbow:1,shoulder:3,neck:1,thoracic:1,lowerBack:1,si:0,hip:1,groin:0,knee:0,ankle:0,foot:0},
   technique:3, mobility:2, strength:3, kcalPerRep:[2.5, 4.0],
  ...
  {id:15, name:"Fingertip Handstand", alt:"Freestanding fingertip hold · fingertip balance",
   muscles:[{n:"Shoulders",p:true},{n:"Finger Flexors",p:true},{n:"Forearms",p:true},{n:"Core",p:true}],
   tags:["shoulders","core","wrists","fingers"],
   diff:8, str:{suit:true,eff:3}, vol:{suit:false,eff:1}, end:{suit:true,eff:3},
   risk:4, joints:{fingers:5,wrist:2,elbow:1,shoulder:3,neck:1,thoracic:1,lowerBack:2,si:0,hip:1,groin:0,knee:0,ankle:0,foot:0},
   technique:5, mobility:2, strength:4, kcalPerRep:[4.0, 6.5],
  ...
  {id:16, name:"Wall Fingertip Handstand Push-Up", alt:"Fingertip HSPU · fingertip wall push-up",
   muscles:[{n:"Shoulders",p:true},{n:"Triceps",p:true},{n:"Finger Flexors",p:true},{n:"Forearms",p:true}],
   tags:["shoulders","triceps","fingers"],
   diff:7, str:{suit:true,eff:5}, vol:{suit:true,eff:3}, end:{suit:false,eff:1},
   risk:5, joints:{fingers:5,wrist:2,elbow:3,shoulder:4,neck:2,thoracic:1,lowerBack:1,si:0,hip:0,groin:0,knee:0,ankle:0,foot:0},
   technique:4, mobility:2, strength:4, kcalPerRep:[1.0, 1.8],
  ...
  {id:17, name:"Deficit Fingertip Handstand Push-Up", alt:"Parallette fingertip HSPU · deep fingertip push-up",
   muscles:[{n:"Shoulders",p:true},{n:"Triceps",p:true},{n:"Finger Flexors",p:true},{n:"Forearms",p:true}],
   tags:["shoulders","triceps","fingers"],
   diff:8, str:{suit:true,eff:5}, vol:{suit:false,eff:2}, end:{suit:false,eff:1},
   risk:5, joints:{fingers:5,wrist:2,elbow:4,shoulder:5,neck:2,thoracic:1,lowerBack:1,si:0,hip:0,groin:0,knee:0,ankle:0,foot:0},
   technique:4, mobility:3, strength:5, kcalPerRep:[1.3, 2.2],
  ...
  {id:18, name:"Freestanding Fingertip Handstand Push-Up", alt:"Free fingertip HSPU · freestanding fingertip push-up",
   muscles:[{n:"Shoulders",p:true},{n:"Triceps",p:true},{n:"Finger Flexors",p:true},{n:"Core",p:true}],
   tags:["shoulders","triceps","fingers","core"],
   diff:10, str:{suit:true,eff:5}, vol:{suit:false,eff:1}, end:{suit:false,eff:1},
   risk:5, joints:{fingers:5,wrist:2,elbow:3,shoulder:5,neck:2,thoracic:1,lowerBack:2,si:0,hip:1,groin:0,knee:0,ankle:0,foot:0},
   technique:5, mobility:3, strength:5, kcalPerRep:[1.8, 3.0],
   hof:true,
  ...
  {id:19, name:"One-Arm Wall Handstand", alt:"Wall OAH · assisted one-arm handstand",
   muscles:[{n:"Shoulders",p:true},{n:"Core",p:true},{n:"Forearms",p:true},{n:"Wrists",p:false}],
   tags:["shoulders","core","wrists"],
   diff:8, str:{suit:true,eff:3}, vol:{suit:false,eff:1}, end:{suit:true,eff:2},
   risk:4, joints:{fingers:3,wrist:5,elbow:2,shoulder:4,neck:1,thoracic:2,lowerBack:3,si:1,hip:2,groin:0,knee:0,ankle:0,foot:0},
   technique:5, mobility:2, strength:4, kcalPerRep:[3.5, 6.0],
  ...
  {id:20, name:"One-Arm Fingertip Handstand", alt:"OAH fingertips · one-arm fingertip balance",
   muscles:[{n:"Shoulders",p:true},{n:"Core",p:true},{n:"Finger Flexors",p:true},{n:"Forearms",p:true}],
   tags:["shoulders","core","wrists","fingers"],
   diff:10, str:{suit:true,eff:3}, vol:{suit:false,eff:1}, end:{suit:false,eff:1},
   risk:5, joints:{fingers:5,wrist:3,elbow:2,shoulder:5,neck:1,thoracic:2,lowerBack:4,si:2,hip:3,groin:0,knee:0,ankle:0,foot:0},
  ...
  {id:21, name:"One-Arm Wall Handstand Push-Up", alt:"One-arm wall HSPU · unilateral HSPU",
   muscles:[{n:"Shoulders",p:true},{n:"Triceps",p:true},{n:"Core",p:true},{n:"Forearms",p:true}],
   tags:["shoulders","triceps","core"],
   diff:9, str:{suit:true,eff:5}, vol:{suit:false,eff:1}, end:{suit:false,eff:1},
   risk:5, joints:{fingers:3,wrist:5,elbow:4,shoulder:5,neck:2,thoracic:2,lowerBack:3,si:1,hip:1,groin:0,knee:0,ankle:0,foot:0},
   technique:5, mobility:3, strength:5, kcalPerRep:[2.0, 3.5],
   hof:true,
   ...
   equipment:"Wall (parallettes recommended)", position:"Inverted", youtube:"LINK_TODO"},

  {id:22, name:"One-Arm Fingertip Handstand Push-Up", alt:"One-arm fingertip HSPU · fingertip unilateral HSPU",
   muscles:[{n:"Shoulders",p:true},{n:"Triceps",p:true},{n:"Finger Flexors",p:true},{n:"Core",p:true}],
   tags:["shoulders","triceps","fingers","core"],
   diff:10, str:{suit:true,eff:5}, vol:{suit:false,eff:1}, end:{suit:false,eff:1},
   risk:5, joints:{fingers:5,wrist:3,elbow:4,shoulder:5,neck:2,thoracic:2,lowerBack:4,si:2,hip:2,groin:0,knee:0,ankle:0,foot:0},
   technique:5, mobility:3, strength:5, kcalPerRep:[3.5, 6.0],
   hof:true,
   ...
   equipment:"Wall or freestanding (parallettes strongly recommended)", position:"Inverted", youtube:"LINK_TODO"},

  /* ── SHAPE VARIANTS ─────────────────────────────────────── */

  {id:23, name:"Straddle Handstand", alt:"Straddle hold · wide-leg handstand",
   muscles:[{n:"Shoulders",p:true},{n:"Core",p:true},{n:"Adductors",p:false},{n:"Wrists",p:false}],
   tags:["shoulders","core","wrists"],
   diff:4, str:{suit:false,eff:1}, vol:{suit:false,eff:1}, end:{suit:true,eff:4},
   risk:2, joints:{fingers:2,wrist:3,elbow:1,shoulder:3,neck:1,thoracic:1,lowerBack:1,si:0,hip:2,groin:2,knee:0,ankle:0,foot:0},
   technique:3, mobility:2, strength:2, kcalPerRep:[2.0, 3.5],
  ...
  {id:24, name:"Split Handstand", alt:"Scissors handstand · front-back split hold",
   muscles:[{n:"Shoulders",p:true},{n:"Core",p:true},{n:"Hip Flexors",p:false},{n:"Hamstrings",p:false}],
   tags:["shoulders","core"],
   diff:5, str:{suit:false,eff:1}, vol:{suit:false,eff:1}, end:{suit:true,eff:3},
   risk:3, joints:{fingers:2,wrist:3,elbow:1,shoulder:3,neck:1,thoracic:1,lowerBack:2,si:1,hip:4,groin:3,knee:0,ankle:0,foot:0},
   technique:4, mobility:4, strength:2, kcalPerRep:[2.5, 4.0],
  ...
  {id:25, name:"Arch Handstand", alt:"Banana handstand · hollowback handstand",
   muscles:[{n:"Shoulders",p:true},{n:"Spinal Erectors",p:true},{n:"Glutes",p:false},{n:"Core",p:false}],
   tags:["shoulders","core"],
   diff:3, str:{suit:false,eff:1}, vol:{suit:false,eff:1}, end:{suit:true,eff:2},
   risk:3, joints:{fingers:2,wrist:3,elbow:1,shoulder:2,neck:2,thoracic:3,lowerBack:4,si:1,hip:1,groin:0,knee:0,ankle:0,foot:0},
   technique:2, mobility:2, strength:1, kcalPerRep:[1.5, 2.5],
  ...
  {id:26, name:"Stag Handstand", alt:"Stag hold · bent-knee split handstand",
   muscles:[{n:"Shoulders",p:true},{n:"Core",p:true},{n:"Hip Flexors",p:false},{n:"Quadriceps",p:false}],
   tags:["shoulders","core"],
   diff:5, str:{suit:false,eff:1}, vol:{suit:false,eff:1}, end:{suit:true,eff:3},
   risk:2, joints:{fingers:2,wrist:3,elbow:1,shoulder:3,neck:1,thoracic:1,lowerBack:2,si:0,hip:3,groin:1,knee:2,ankle:0,foot:0},
   technique:4, mobility:3, strength:2, kcalPerRep:[2.5, 4.0],
  ...
  {id:27, name:"One-Leg Handstand", alt:"Single-leg handstand · unicorn handstand",
   muscles:[{n:"Shoulders",p:true},{n:"Core",p:true},{n:"Hip Flexors",p:false},{n:"Wrists",p:false}],
   tags:["shoulders","core","wrists"],
   diff:6, str:{suit:false,eff:1}, vol:{suit:false,eff:1}, end:{suit:true,eff:3},
   risk:3, joints:{fingers:2,wrist:4,elbow:1,shoulder:3,neck:1,thoracic:1,lowerBack:3,si:1,hip:2,groin:0,knee:0,ankle:0,foot:0},
   technique:4, mobility:2, strength:2, kcalPerRep:[2.5, 4.0],
  ...
  {id:28, name:"Jump to Handstand", alt:"Two-foot jump entry · jump kick-up",
   muscles:[{n:"Shoulders",p:true},{n:"Core",p:true},{n:"Hip Flexors",p:false},{n:"Wrists",p:false}],
   tags:["shoulders","core","wrists"],
   diff:4, str:{suit:false,eff:1}, vol:{suit:false,eff:1}, end:{suit:false,eff:2},
   risk:3, joints:{fingers:1,wrist:3,elbow:1,shoulder:3,neck:1,thoracic:0,lowerBack:2,si:0,hip:2,groin:0,knee:1,ankle:1,foot:0},
   technique:4, mobility:1, strength:2, kcalPerRep:[1.0, 1.8],
  ...
  {id:29, name:"Cartwheel to Handstand", alt:"Cartwheel entry · cartwheel kick-up",
   muscles:[{n:"Shoulders",p:true},{n:"Core",p:true},{n:"Hip Flexors",p:false},{n:"Wrists",p:false}],
   tags:["shoulders","core","wrists"],
   diff:5, str:{suit:false,eff:1}, vol:{suit:false,eff:1}, end:{suit:false,eff:2},
   risk:3, joints:{fingers:1,wrist:3,elbow:1,shoulder:3,neck:1,thoracic:1,lowerBack:1,si:0,hip:3,groin:1,knee:0,ankle:1,foot:0},
   technique:5, mobility:2, strength:2, kcalPerRep:[1.5, 2.5],
  ...
  {id:30, name:"Tiger Bend Handstand", alt:"Tiger bend · forearm press to handstand",
   muscles:[{n:"Shoulders",p:true},{n:"Triceps",p:true},{n:"Core",p:true},{n:"Forearms",p:false}],
   tags:["shoulders","triceps","core"],
   diff:8, str:{suit:true,eff:4}, vol:{suit:false,eff:1}, end:{suit:false,eff:1},
   risk:4, joints:{fingers:2,wrist:3,elbow:5,shoulder:5,neck:2,thoracic:2,lowerBack:2,si:0,hip:1,groin:0,knee:0,ankle:0,foot:0},
   technique:5, mobility:3, strength:5, kcalPerRep:[2.5, 4.5],
   hof:true,
   ...
   equipment:"None (parallettes optional for wrist angle)", position:"Inverted", youtube:"LINK_TODO"},
