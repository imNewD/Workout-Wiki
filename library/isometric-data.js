...
const isometrics = [
  ...
  {
    id: 1,
    name: "L-Sit (Parallettes / Floor / Dip Bars)",
  ...
  {
    id: 2,
    name: "Tuck L-Sit (Parallettes / Floor / Dip Bars)",
  ...
  {
    id: 5,
    name: "Planche Lean (Parallettes / Floor)",
  ...
  {
    id: 6,
    name: "Tuck Planche (Parallettes / Floor)",
  ...
  {
    id: 7,
    name: "Advanced Tuck Planche (Parallettes / Floor)",
  ...
  {
    id: 8,
    name: "Straddle Planche (Parallettes / Floor)",
...

  {
    ...
    alt: "Ring tuck planche · tuck planche on rings",
    muscles: [
      {n:"Shoulders", p:true},
      {n:"Core", p:true},
      {n:"Serratus", p:true},
    ...
    risk: 4,
    joints: {fingers:2, wrist:2, elbow:2, shoulder:5, neck:1, thoracic:1, lowerBack:2, si:0, hip:2, groin:0, knee:1, ankle:0, foot:0},
    technique: 5,
    mobility: 2,
    strength: 5,
    kcalPerRep: [2.5, 4],
    desc: "A tuck planche performed on gymnastic rings — identical position to the parallette tuck planche but with the rings free to rotate and spread, demanding continuous active suppression (turning the rings out) throughout the hold. The instability eliminates any passive reliance on a fixed base, recruiting the chest, biceps, and rotator cuff as active stabilisers in addition to the standard planche musculature. Significantly harder than the parallette equivalent despite the same lever length.",
    cues: "Turn the rings out aggressively throughout — rings rotating inward is the first sign of shoulder fatigue. The hold should feel like every muscle in the upper body is firing simultaneously. If you cannot hold the rings turned out, the prerequisite strength is not yet there.",
...

  {
    ...
    alt: "Ring straddle planche · straddle planche on rings",
    muscles: [
      {n:"Shoulders", p:true},
      {n:"Core", p:true},
      {n:"Serratus", p:true},
    ...
    risk: 4,
    joints: {fingers:2, wrist:2, elbow:2, shoulder:5, neck:1, thoracic:1, lowerBack:3, si:1, hip:3, groin:2, knee:0, ankle:0, foot:0},
    technique: 5,
    mobility: 3,
    strength: 5,
    kcalPerRep: [3.5, 6],
    desc: "A straddle planche on gymnastic rings — the full lever length of the straddle position combined with the rotational instability of the rings. The demand on the anterior deltoid, serratus, and chest to maintain both horizontal alignment and ring suppression simultaneously makes this one of the hardest non-full-planche holds in calisthenics. A prerequisite for the full planche on rings and a respected standalone benchmark.",
    cues: "Rings turned out throughout — without suppression the rings will collapse inward and the hold fails immediately. The straddle width can be used to manage difficulty as on parallettes, but the instability ceiling is much lower on rings. Expect holds 30–50% shorter than your parallette straddle.",
    equipment: "Gymnastic rings",
    position: "Prone",
    youtube: "LINK_TODO"
  },

  {
    ...
    alt: "Ring planche · planche on rings",
    muscles: [
      {n:"Shoulders", p:true},
      {n:"Core", p:true},
      {n:"Serratus", p:true},
    ...
    risk: 5,
    joints: {fingers:2, wrist:2, elbow:3, shoulder:5, neck:1, thoracic:1, lowerBack:3, si:1, hip:2, groin:0, knee:0, ankle:0, foot:0},
    technique: 5,
    mobility: 3,
    strength: 5,
    kcalPerRep: [5, 9],
    hof: true,
    desc: "The full planche performed on gymnastic rings — body completely horizontal, legs together and straight, rings turned out, arms locked. Every demand of the parallette full planche is present with the addition of continuous rotational stabilisation through the shoulder and elbow. Considered the hardest planche variation achievable and one of the rarest strength demonstrations in all of calisthenics. Requires full ownership of both the parallette full planche and ring straddle planche as prerequisites.",
    cues: "No one reaches this without an established parallette full planche first. The transition to rings must be gradual — begin with tuck, then straddle on rings before attempting full. Ring suppression must be maintained even as the shoulder and core are at absolute capacity. Any inward ring rotation under load is a soft tissue injury risk.",
    equipment: "Gymnastic rings",
    position: "Prone",
    youtube: "LINK_TODO"
  },
  ...
  {
    id: 17,
    name: "Human Flag (Pole / Wall Bars)",
  ...
  {
    id: 19,
    name: "Ring Dip Support Hold (Rings)",
  ...
  {
    id: 26,
    name: "Elbow Lever (Parallettes / Floor)",
  ...
  {
    id: 27,
    name: "One-Arm Elbow Lever (Parallettes / Floor)",
  ...
  {
    id: 29,
    name: "Active German Hang (Bar / Rings)",
 ...
 /* ── ADDITIONAL CORE ISOMETRICS ──────────────────────────── */
  ...
  {
    id: 30,
    name: "Dragon Flag Hold (Bench / Floor)",
  ...
  {
    id: 33,
    name: "Straddle HF (Pole / Wall Bars)",
  ...
  {
    id: 37,
    name: "One-Arm Front Lever (Bar / Rings)",
  ...
  {
    id: 43,
    name: "One-Leg Front Lever (Bar / Rings)",
 ...
 /* ── HUMAN FLAG — ADDITIONAL VARIANTS ───────────────────── */
  ...
  {
    id: 45,
    name: "One-Arm HF (Pole / Wall Bars)",
  ...
  {
    id: 46,
    name: "Inverted HF (Pole / Wall Bars)",
  ...
  {
    id: 47,
    name: "Straddle L-Sit (Parallettes / Floor / Dip Bars)",
  ...
  {
    id: 48,
    name: "Tucked V-Sit (Parallettes / Floor)",
  ...
  {
    id: 49,
    name: "One-Arm L-Sit (Parallettes / Floor)",
  ...
  {
    id: 50,
    name: "One-Arm Hanging L-Sit (Bar / Rings)",
  ...
  {
    id: 52,
    name: "One-Arm Dead Hang (Bar / Rings)",
  ...
  {
    id: 53,
    name: "One-Arm Active Hang (Bar / Rings)",
  ...
  {
    id: 54,
    name: "Fingertip Hang (Bar / Rings / Ledge)",
  ...
  {
    id: 55,
    name: "Pinch Grip Hang (Bar / Ledge)",
  ...
  {
    id: 59,
    name: "Copenhagen Plank Hold (Bench)",
  ...
  {
    id: 60,
    name: "Tuck Dragon Flag Hold (Bench / Floor)",
  ...
  {
    id: 62,
    name: "Jefferson Curl Hold (Bar / Rings)",
  ...
  {
    id: 63,
    name: "Straddle Elbow Lever (Parallettes / Floor)",
...
const isometricPantheonWorkouts = [
  {
      id: 36,
      name: "Victorian Cross (Rings)",
