/* ══════════════════════════════════════════════════════════════
   ...
   backlever-data.js  ·  SINGLE SOURCE OF TRUTH for all back lever exercises.

   LOAD ORDER: this file must load BEFORE isometric-data.js.

   Exposes (globals):
     backleverBaseStatics   — base static holds → consumed by isometric-data.js
     backlevers             — complete back lever exercise library
     window.backleverStaticWorkouts
     window.backleverPrepWorkouts
     window.backleverDynamicWorkouts
   ...
   ─ Mid (diff 7–8)    Half-Lay Back Lever · One-Leg Back Lever
...
const _blOneLeg = {
    id: 44,
    name: "One-Leg Back Lever — Parallettes",
...
const backlevers = (() => {
  ...
  ───────────────────────────────────────────────────────────────────── */
    ...
    entries.push(cloneExercise(tuck, {
      ...
      diff: 5,
      strength: 2.5, risk: 2.5, technique: 3, mobility: 2,
      equipment: 'Parallettes',
      position: 'Inverted',
    ...
    entries.push(cloneExercise(tuck, {
      ...
      diff: 6,
      strength: 3, risk: 3, technique: 3.5, mobility: 2,
  ...
  ───────────────────────────────────────────────────────────────────── */
    ...
    entries.push(tuck); // id:11  Tuck Back Lever — Parallettes (base static)
    ...
    entries.push(cloneExercise(tuck, {
      ...
      tags: ['shoulders', 'chest', 'core', 'bar'],
      diff: 6,
      strength: 3.5, risk: 2, technique: 3.5, mobility: 2,
      equipment: 'Pull-up bar',
      position: 'Inverted',
    ...
    entries.push(cloneExercise(tuck, {
      ...
      tags: ['shoulders', 'chest', 'core', 'rings'],
      diff: 7,
      strength: 3.5, risk: 3, technique: 4, mobility: 2,
      equipment: 'Gymnastic rings',
      position: 'Inverted',
  ...
  ───────────────────────────────────────────────────────────────────── */
    ...
    entries.push(cloneExercise(tuck, {
      ...
      tags: ['shoulders', 'chest', 'core', 'parallettes'],
      diff: 7,
      strength: 4, risk: 2.5, technique: 3.5, mobility: 2,
      equipment: 'Parallettes',
      position: 'Inverted',
      joints: { fingers:3, wrist:2, elbow:3, shoulder:5, neck:1, thoracic:3, lowerBack:3, si:1, hip:2, groin:0, knee:2, ankle:0, foot:0 },
    ...
    entries.push(cloneExercise(tuck, {
      ...
      tags: ['shoulders', 'chest', 'core', 'rings'],
      diff: 8,
      strength: 4.5, risk: 3, technique: 4, mobility: 2,
      equipment: 'Gymnastic rings',
      position: 'Inverted',
      joints: { fingers:3, wrist:3, elbow:3, shoulder:5, neck:1, thoracic:3, lowerBack:3, si:1, hip:2, groin:0, knee:2, ankle:0, foot:0 },
  ...
  ───────────────────────────────────────────────────────────────────── */
    ...
    entries.push(halfLay); // id:45  Half-Lay Back Lever — Parallettes (base static)
    ...
    entries.push(cloneExercise(halfLay, {
      ...
      tags: ['shoulders', 'chest', 'core', 'bar'],
      diff: 7,
      strength: 4, risk: 3, technique: 3.5, mobility: 2,
      equipment: 'Pull-up bar',
      position: 'Inverted',
      joints: { fingers:3, wrist:3, elbow:3, shoulder:5, neck:1, thoracic:3, lowerBack:3, si:1, hip:2, groin:0, knee:2, ankle:0, foot:0 },
  ...
  ───────────────────────────────────────────────────────────────────── */
    ...
    entries.push(oneLeg); // id:44  One-Leg Back Lever — Parallettes (base static)

    entries.push(cloneExercise(oneLeg, {
      id: 2010,
      name: 'One-Leg Back Lever — Bar',
  ...
  ───────────────────────────────────────────────────────────────────── */
    ...
    entries.push(straddle); // id:29  Straddle Back Lever — Parallettes (base static)
    ...
    entries.push(cloneExercise(straddle, {
      ...
      tags: ['shoulders', 'chest', 'core', 'bar'],
      diff: 8,
      strength: 4.5, risk: 3, technique: 4, mobility: 3,
      equipment: 'Pull-up bar',
      position: 'Inverted',
    ...
    entries.push(cloneExercise(straddle, {
      ...
      tags: ['shoulders', 'chest', 'core', 'rings'],
      diff: 9,
      strength: 5, risk: 3.5, technique: 4.5, mobility: 3,
      equipment: 'Gymnastic rings',
      position: 'Inverted',
      joints: { fingers:3, wrist:3, elbow:3, shoulder:5, neck:1, thoracic:3, lowerBack:4, si:2, hip:2, groin:1, knee:0, ankle:0, foot:0 },
  ...
  ───────────────────────────────────────────────────────────────────── */
    ...
    entries.push(full); // id:12  Back Lever — Parallettes (base static)
  ...
  ───────────────────────────────────────────────────────────────────── */
    ...
    entries.push(cloneExercise(tuck, {
      ...
      tags: ['shoulders', 'chest', 'core', 'bar'],
      diff: 6,
      strength: 3.5, risk: 2.5, technique: 3, mobility: 2,
      equipment: 'Pull-up bar',
    ...
    entries.push(cloneExercise(straddle, {
      ...
      tags: ['shoulders', 'chest', 'core', 'bar'],
      diff: 8,
      strength: 4.5, risk: 3.5, technique: 4, mobility: 3,
      equipment: 'Pull-up bar',
      position: 'InvertedDynamic',
    ...
    entries.push(cloneExercise(full, {
      id: 2035,
      name: 'Back Lever Negatives — Parallettes',
    ...
    entries.push(cloneExercise(full, {
      id: 2036,
      name: 'Back Lever Raises — Parallettes',
    ...
    entries.push(cloneExercise(full, {
      id: 2039,
      name: 'Back Lever — Rings Supinated',
  ...
  ───────────────────────────────────────────────────────────────────── */
    ...
    entries.push(cloneExercise(straddle, {
      id: 2062,
      name: 'Straddle Back Lever Pull-ups — Bar',
      alt: 'Straddle back lever pull-up on pull-up bar',
      tags: ['shoulders', 'chest', 'core', 'biceps', 'bar'],
      diff: 9.5,
      strength: 5, risk: 4.5, technique: 4.5, mobility: 3,
      equipment: 'Pull-up bar',
      position: 'InvertedDynamic',
  ...
  function isCompletedBackLeverVariant(exercise) {
    ...
    return name === 'Back Lever'
      ...
      || name.startsWith('One-Arm Back Lever');
  }
