...
const dips = [
  ...
  {
    id: 34,
    name: "Tuck Planche Dip | (Parallettes)",
  ...
  {
    id: 51,
    name: "Adv Tuck Planche Dip | (Parallettes)",
  ...
  {
    id: 41,
    name: "Straddle Planche Dip | (Parallettes)",
  ...
  {
    id: 42,
    name: "Full Planche Dip | (Parallettes)",
  ...
  {
    id: 76,
    name: "Tuck Planche Dip | (Rings)",
    alt: "Tuck planche press ring dip",
    muscles: [
      {n:"Triceps", p:true},
      {n:"Chest", p:true},
      {n:"Shoulders", p:true},
    ...
    risk: 5,
    joints: {fingers:5, wrist:5, elbow:4, shoulder:5, neck:0, thoracic:1, lowerBack:3, si:0, hip:3, groin:0, knee:0, ankle:0, foot:0},
    technique: 5,
    mobility: 3,
    strength: 5,
    kcalPerRep: [0.42, 0.75],
    desc: "A dip performed while maintaining a tuck planche on gymnastic rings — hips elevated, knees tucked, body roughly horizontal, supported only on the freely rotating rings. The tuck planche on rings is already substantially harder to hold than on fixed bars because every shift in body position causes both rings to rotate and swing independently. Adding the pressing motion compounds this: the forward-and-downward pressing angle of the tuck geometry must be generated against rings that destabilise with every degree of elbow movement. Among the most extreme pressing feats on rings outside of full planche work. The tuck planche on parallettes must be completely mastered before this is approached.",
    cues: "A stable tuck planche ring hold for several seconds is the absolute prerequisite — not just on parallettes. Even a partial rep is an extraordinary achievement. Wrist conditioning specific to rings under planche loading must be built progressively over months.",
    equipment: "Rings",
    position: "Elevated",
    youtube: "LINK_TODO"
  },
  ...
  {
    id: 77,
    name: "Adv Tuck Planche Dip | (Rings)",
    alt: "Adv tuck planche press ring dip",
    muscles: [
      {n:"Triceps", p:true},
      {n:"Chest", p:true},
      {n:"Shoulders", p:true},
    ...
    strength: 5,
    kcalPerRep: [0.44, 0.79],
    desc: "A dip performed while maintaining an advanced tuck planche on rings — hips fully extended so the back is flat and horizontal, knees at roughly 90°. Extending the hips from the tuck position dramatically increases the lever arm and the demands on the wrists, anterior deltoids, and core — and on rings this is compounded by the rotational freedom of each ring independently responding to the increased moment arm. The back must remain parallel to the floor throughout the pressing motion; any hip sag or pike under ring instability terminates the rep. One of the rarest pressing movements achievable on rings.",
    cues: "The advanced tuck planche ring hold must be stable and flat before any pressing motion is introduced. Progress in strict order from the tuck planche ring dip. Any deviation of the hips from horizontal during the press means the static position is not yet controlled enough.",
    equipment: "Rings",
    position: "Elevated",
    youtube: "LINK_TODO"
  },
  ...
  {
    id: 78,
    name: "Straddle Planche Dip | (Rings)",
    alt: "Straddle planche press ring dip",
    muscles: [
      {n:"Triceps", p:true},
      {n:"Chest", p:true},
      {n:"Shoulders", p:true},
    ...
    desc: "A dip performed while maintaining a straddle planche on gymnastic rings — legs extended and spread wide, body fully horizontal, on independently rotating rings. The straddle position reduces the lever arm compared to a full planche but adds hip abductor and adductor engagement to stabilise the leg spread against gravity. On rings, the extended leg lever creates asymmetric forces on each ring that must be actively balanced throughout every rep. The combination of straddle planche strength and ring-specific stabilisation makes this effectively unseen outside of elite competitive gymnastics on rings.",
    cues: "The straddle planche ring hold must be stable before any pressing motion is added. Even the parallettes straddle planche dip should be completely mastered first. Hip drop or ring splay at any point terminates the rep. Years of dedicated planche and ring training in parallel are required before this is conceptually approachable.",
    equipment: "Rings",
    position: "Elevated",
    youtube: "LINK_TODO"
  }
