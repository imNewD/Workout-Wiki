...
const pushups = [
...

  {
    ...
    strength: 3,
    kcalPerRep: [0.22, 0.4],
    desc: "Explosive push-up where the hands leave the floor and clap together at the peak before landing. The clap is the defining feature — it serves as an objective marker of height and explosive power output.",
    cues: "Land with soft elbows. Clap high — if you are rushing the clap you did not generate enough power.",
    equipment: "None",
    position: "Prone",
    youtube: "LINK_TODO"
  },

  {
    ...
    strength: 3,
    kcalPerRep: [0.22, 0.4],
    desc: "Explosive push-up where both hands leave the floor at the top of the press. The goal is maximum power output and air time — not a specific hand action at the peak. The base variation from which all clap and plyometric push-up progressions stem.",
    cues: "Land with soft elbows. Drive through the entire palm for maximum height. Focus on power generation, not what the hands do at the top.",
    equipment: "None",
    position: "Prone",
    youtube: "LINK_TODO"
  },
  ...
  {
    id: 15,
    name: "Pike Push-Up | Feet Elevated (Elevated surface)",
  ...
  {
    id: 105,
    name: "One Arm Push-Up | Incline (Elevated surface)",
...

  {
    ...
    id: 112,
    name: "Elbow Lever Push-Up (Parallettes)",
  ...
  {
    id: 118,
    name: "One Arm Push-Up | Decline Straddle (Elevated surface)",
  ...
  {
    id: 131,
    name: "Pelican Push-Up (Parallettes)",
    ...
    desc: "A deep-range push-up performed on low parallettes, allowing the chest to descend far below the shoulder line while the elbows sweep back behind the torso. The parallettes provide a stable, fixed base and a neutral wrist position throughout the extreme range of motion. The loading is concentrated through the anterior shoulder, chest, and triceps, while the bottom position demands exceptional joint control and core stability.",
    cues: "Use low parallettes for maximum depth. Move slowly through the deepest safe range. Keep the core locked and avoid lower-back sag as the shoulders descend. Build from deep decline push-ups or planche push-up work before attempting full Pelican depth.",
  ...
  {
    id: 137,
    name: "Pelican Push-Up (Rings)",
    alt: "Ring Pelican Push-Up · extreme ROM ring push-up",
    muscles: [
      {n:"Chest", p:true},
      {n:"Triceps", p:true},
      {n:"Shoulders", p:true},
    ...
    mobility: 3,
    strength: 5,
    kcalPerRep: [0.44, 0.80],
    desc: "A deep-range push-up performed on low gymnastic rings, allowing the chest to descend far below the shoulder line while the elbows sweep back behind the torso. The rings introduce rotational instability on top of an already extreme range of motion — the rings track naturally with the arm path but must be actively controlled to prevent lateral drift at the bottom. Significantly harder than the parallette version due to the absence of a fixed base.",
    cues: "Set rings very low. Allow the rings to track naturally but resist lateral drift actively. Move slowly — the rings amplify any loss of control. Only attempt after the parallette Pelican is well established.",
    equipment: "Gymnastic rings",
    position: "Prone",
    youtube: "LINK_TODO"
  }];
