...
const PANTHEON_EXERCISES = [
  ...
  },
  {
    ...
    str: {suit:true, eff:5}, vol: {suit:false, eff:1}, end: {suit:false, eff:1},
    risk: 4,
    joints: {wrist:2, elbow:3, shoulder:4, neck:1, lowerBack:3, hip:2, knee:0, fingers:2, thoracic:2, si:1, groin:0, ankle:0, foot:0},
    technique: 5, mobility: 2, strength: 5,
    kcalPerRep: [0.44, 0.79],
  ...
  /* ══════════════════════════════════════════════════════
     ICE CREAM MAKER FAMILY (RINGS)
     Gate: pullup-104 (Ice Cream Maker — full, bar)
  ══════════════════════════════════════════════════════ */
  {
    id: 304,
    ...
    requiresMode: "all",
    pantheonGroup: "Front Lever",
    pantheonSubgroup: "Ice Cream Maker",
