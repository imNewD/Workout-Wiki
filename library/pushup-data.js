...
const pushups = [
...

  {
    ...
    strength: 5,
    kcalPerRep: [0.34, 0.61],
    desc: "A one-arm push-up with feet elevated on a bench or box and legs spread wide in a straddle stance. The wide foot placement reduces the rotational core demand compared to the strict narrow-stance version (id:63), making the unilateral pressing strength — not anti-rotation — the primary limiter. The decline angle still shifts load heavily onto the upper chest and anterior deltoid. The natural step between the flat straddle OAP and the full feet-elevated strict OAP.",
...

  {
    ...
    risk: 5,
    joints: {wrist:5, elbow:2, shoulder:1, neck:1, lowerBack:1, knee:0, fingers:5, thoracic:1, si:0, hip:1, groin:0, ankle:0, foot:1},
    technique: 5,
    mobility: 1,
    strength: 4,
