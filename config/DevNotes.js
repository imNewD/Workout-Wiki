const DEVLOG_VERSION = 'V1.88';
const DEVLOG_ENTRIES = [
  {
    ver: 'V1.88',
    date: 'July 2026',
    items: [
      { tag:'fix', text:'FIX: Various bugs and visual errors corrected.' },
      { tag:'fix', text:'FIX: Reference links improved for clarity — Info & FAQ sources now link directly to the specific cited study where one exists, instead of a generic journal homepage.' },
    ]
  },
  {
    ver: 'V1.87',
    date: 'July 2026',
    items: [
      { tag:'fix', text:'Progression Tree — Planche and Front Lever branch grouping fixed so variants only ever group with others of the same difficulty tier, and equipment variants (Rings, Parallettes) no longer stand in for the main exercise when a floor/bar version exists.' },
      { tag:'new', text:'NEW: Front Lever — Beginner and Front Lever — Intermediate training programs added to the Programs library.' },
    ]
  },
  {
    ver: 'V1.86',
    date: 'July 2026',
    items: [
      { tag:'new', text:'New UI styles added — refreshed visual polish across components and layouts.' },
  ...
  },
  {
    ...
    date: 'July 2026',
    items: [
      { tag:'new', text:'Unlock celebrations are now customizable through Achievements — pick World Cutting Slash, Landed, Summer Melt or Unbroken (or keep classic Glass Break) independently for Basic, Hall of Fame and Pantheon exercise unlocks.' },
      { tag:'fix', text:'Themes no longer freeze or glitch while scrolling — animated backgrounds now pause for the brief moment of an active scroll instead of fighting it for every frame.' },
      { tag:'new', text:'Gym now unlocks by logging 100kg+ on any tracked lift; Cardio unlocks by completing the Long Run (10km).' },
      { tag:'fix', text:'Removed the Back Lever programs and the non-functional High Performance achievement hex. Summer theme’s waves now have real foam texture instead of a plain blur.' },
    ]
  },
  {
    ver: 'V1.84',
