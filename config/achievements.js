...
(function () {
  ...
  /* Interface skins (glass/glassmorph/neo/skeu/clay/spatial) — each its
     own hex, gated by player level. Two share the top tier since there
     were 6 skins but only 5 requested tiers (10/25/50/75/100). */
  const UI_STYLE_LEVELS = { glass: 10, glassmorph: 25, neo: 50, skeu: 75, clay: 100, spatial: 100 };
