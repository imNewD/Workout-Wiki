...
const NUTRIENT_INFO = {
  ...
  'Ashwagandha': {
    display: 'Ashwagandha | KSM-66 / Withania somnifera',
    role: 'Ashwagandha is an adaptogenic root extract (Withania somnifera) used in Ayurvedic medicine and now supported by a growing body of clinical evidence. Its primary active compounds — withanolides — modulate the HPA (hypothalamic-pituitary-adrenal) axis, reducing the cortisol response to both physical and psychological stress. It is not a stimulant and has no acute effect; benefits accumulate over 4–8 weeks of consistent use.',
    fitness: 'Documented athletic benefits: (1) Cortisol reduction of 15–25% in chronically stressed individuals — lower cortisol in recovery windows means more anabolism and less muscle breakdown. (2) Strength gains: KSM-66 trials show modest but statistically significant improvements in 1RM bench and leg press vs. placebo over 8 weeks. (3) Aerobic capacity: VO₂max improvements (~3–7%) in multiple controlled trials. (4) Sleep quality: reduces sleep-onset latency and improves subjective sleep depth via GABAergic mechanisms. (5) Testosterone: some evidence for modest increases in stressed or low-testosterone individuals, less clear in well-trained athletes. Dose: 300–600 mg of a standardised root extract (standardised to ≥5% withanolides) daily, with food. KSM-66 and Sensoril are the most studied proprietary forms.',
    rda: 'No established RDA · Evidence-based dose: 300–600 mg/day of standardised extract',
    sources: [
      { food: 'KSM-66 supplement', amount: '300–600 mg / day', emoji: '🌿' },
      { food: 'Sensoril supplement', amount: '125–250 mg / day', emoji: '🌱' },
    ],
    deficiency: 'Not a dietary essential — deficiency is not a medical concept. Absence of supplementation simply means absence of its adaptogenic effect.',
  },
  'Melatonin': {
